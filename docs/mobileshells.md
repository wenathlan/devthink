...
This document describes the Capacitor source boundary for Android and iOS of the merged repository. The workbench remains the single static UI source under `web/`; Bun builds it before Capacitor synchronizes the generated browser files into native shells.
