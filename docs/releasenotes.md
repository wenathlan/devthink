...
— the digest lane logs into the registry it reads
...
- `devthink-2.0.29.jar`
- `devthink2.0.29.zip`
- `devthink-declarations-2.0.29.zip`
...
- `devthink-sbom-2.0.29.json`
- `devthink-attestations-2.0.29.json`
- `devthink-artifactmanifest-2.0.29.json`
