 ...
 * @module auth/version
 * @description
 * Dynamic Antigravity version resolver for the maene
 * plugin (merged superset of the two prior variants).
 *
 ...
 *
 * Runtime: only node:* builtins + global fetch. Zero external deps.
 *
 * @license MIT
 */
