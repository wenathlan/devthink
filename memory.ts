...
export class sessionmemory {
  ...
  async getconfig(): Promise<endpointconfig | undefined> {
    return this.adapter.get<endpointconfig>("config");
  }
  async setconfig(value: endpointconfig): Promise<void> {
    return this.adapter.set("config", value);
  }
  async getsession(): Promise<agentsession | undefined> {
    return this.adapter.get<agentsession>("session");
  }
  async setsession(value: agentsession): Promise<void> {
    return this.adapter.set("session", value);
  }
  async getplan(): Promise<agentplan | undefined> {
    return this.adapter.get<agentplan>("plan");
  }
  async setplan(value: agentplan): Promise<void> {
    return this.adapter.set("plan", value);
  }
  async getdiagnostic(): Promise<diagnosticreport | undefined> {
    return this.adapter.get<diagnosticreport>("diagnostic");
  }
  async setdiagnostic(value: diagnosticreport): Promise<void> {
    return this.adapter.set("diagnostic", value);
  }
  async getprogress(): Promise<planprogress | undefined> {
    return this.adapter.get<planprogress>("progress");
  }
  async setprogress(value: planprogress): Promise<void> {
    return this.adapter.set("progress", value);
  }
  async getcapabilities(): Promise<capabilityreport | undefined> {
    return this.adapter.get<capabilityreport>("capabilities");
  }
  async setcapabilities(value: capabilityreport): Promise<void> {
    return this.adapter.set("capabilities", value);
  }
  async getsettings(): Promise<runsettings | undefined> {
    return this.adapter.get<runsettings>("settings");
  }
  async setsettings(value: runsettings): Promise<void> {
    return this.adapter.set("settings", value);
  }
  async getaudit(): Promise<auditevent[]> {
    return (await this.adapter.get<auditevent[]>("audit")) ?? [];
  }
  async getoutcomes(): Promise<stepoutcome[]> {
    return (await this.adapter.get<stepoutcome[]>("outcomes")) ?? [];
  }
  ...
  async setmap(map: clickablemap): Promise<void> {
    return this.adapter.set(`map${map.version}`, map);
  }

  /** Returns one stored clickable map by its observation version. */
  async getmap(version: number): Promise<clickablemap | undefined> {
    return this.adapter.get<clickablemap>(`map${version}`);
  }
  ...
  async getobservationversion(): Promise<number | undefined> {
    return this.adapter.get<number>("observationversion");
  }

  /** Returns the key hold registry, persisted so holds survive service worker restarts. */
  async getholds(): Promise<keyholdstate[]> {
    return (await this.adapter.get<keyholdstate[]>("holds")) ?? [];
  }

  /** Replaces the key hold registry after one press or release transition. */
  async setholds(holds: keyholdstate[]): Promise<void> {
    return this.adapter.set("holds", holds);
  }

  /** Returns every dialog decision recorded for the audit trail. */
  async getdialogs(): Promise<dialogdecision[]> {
    return (await this.adapter.get<dialogdecision[]>("dialogs")) ?? [];
  }
  ...
  async getretries(): Promise<retryoutcome[]> {
    return (await this.adapter.get<retryoutcome[]>("retries")) ?? [];
  }
  ...
  async getresolutions(): Promise<resolutionsummary[]> {
    return (await this.adapter.get<resolutionsummary[]>("resolutions")) ?? [];
  }
  ...
  async getdialogpolicy(): Promise<dialogpolicy | undefined> {
    return this.adapter.get<dialogpolicy>("dialogpolicy");
  }
  ...
  async setobservation(record: observationrecord): Promise<void> {
    return this.adapter.set(`observation${record.version}`, record);
  }

  /** Returns one stored observation version. */
  async getobservation(version: number): Promise<observationrecord | undefined> {
    return this.adapter.get<observationrecord>(`observation${version}`);
  }

  /** Returns the observation retention window; an absent setting keeps every capture. */
  private async observationretention(): Promise<number | undefined> {
  ...
  async geta11ytrees(): Promise<a11ycapture[]> {
    return (await this.adapter.get<a11ycapture[]>("a11ytrees")) ?? [];
  }
  ...
  async getreaderarticles(): Promise<readercapture[]> {
    return (await this.adapter.get<readercapture[]>("readerarticles")) ?? [];
  }
  ...
  async getmutationevents(): Promise<mutationevent[]> {
    return (await this.adapter.get<mutationevent[]>("mutationevents")) ?? [];
  }
  ...
  async getfocusevents(): Promise<focusevent[]> {
    return (await this.adapter.get<focusevent[]>("focusevents")) ?? [];
  }
  ...
  async getbanners(): Promise<bannerreport[]> {
    return (await this.adapter.get<bannerreport[]>("banners")) ?? [];
  }
  ...
  async getdiffs(): Promise<snapshotdiff[]> {
    return (await this.adapter.get<snapshotdiff[]>("diffs")) ?? [];
  }
  ...
  async getselectors(): Promise<derivedselector[]> {
    return (await this.adapter.get<derivedselector[]>("selectors")) ?? [];
  }
  ...
  async gettemplates(): Promise<templateprofile[]> {
    return (await this.adapter.get<templateprofile[]>("templates")) ?? [];
  }
  ...
  async getwatches(): Promise<watchregistration[]> {
    return (await this.adapter.get<watchregistration[]>("watches")) ?? [];
  }
  ...
  async closewatch(watchid: string, closedat: number): Promise<void> {
    ...
    await this.adapter.set(
      "watches",
      records.map((watch) =>
        watch.watchid === watchid && watch.closedat === undefined ? { ...watch, closedat } : watch,
      ),
    );
  }

  /** Returns the live page signals of language, template, scroll lock and banner state. */
  async getsignals(): Promise<pagesignals | undefined> {
    return this.adapter.get<pagesignals>("signals");
  }

  /** Replaces the live page signals after an observation step refreshes them. */
  async setsignals(signals: pagesignals): Promise<void> {
  ...
  async gettrail(sessionid: string): Promise<trailentry[]> {
    return (await this.adapter.get<trailentry[]>(`trail${sessionid}`)) ?? [];
  }
  ...
  async getwaitprofiles(): Promise<waitprofilerecord[]> {
    return (await this.adapter.get<waitprofilerecord[]>("waitprofiles")) ?? [];
  }
  ...
  async getnavrecords(): Promise<navrecord[]> {
    return (await this.adapter.get<navrecord[]>("navrecords")) ?? [];
  }
  ...
  async getnavintents(): Promise<navintentrecord[]> {
    return (await this.adapter.get<navintentrecord[]>("navintents")) ?? [];
  }
  ...
  async getratestates(): Promise<ratelimitstate[]> {
    return (await this.adapter.get<ratelimitstate[]>("ratestates")) ?? [];
  }
  ...
  async getcurateds(): Promise<curatedlist[]> {
    return (await this.adapter.get<curatedlist[]>("curated")) ?? [];
  }
  ...
  async getauths(): Promise<authrecord[]> {
    return (await this.adapter.get<authrecord[]>("auths")) ?? [];
  }
  ...
  async getartifacts(): Promise<artifactrecord[]> {
    return (await this.adapter.get<artifactrecord[]>("artifacts")) ?? [];
  }

  /** Returns the navigation control state of paused navigation. */
  async getnavcontrol(): Promise<navcontrol | undefined> {
    return this.adapter.get<navcontrol>("navcontrol");
  }

  /** Replaces the navigation control state after a pause or resume transition. */
  async setnavcontrol(control: navcontrol): Promise<void> {
  ...
  async getsafeties(): Promise<safetyverdict[]> {
    return (await this.adapter.get<safetyverdict[]>("safeties")) ?? [];
  }
  ...
  async getrecenttabs(): Promise<recenttab[]> {
    return (await this.adapter.get<recenttab[]>("recenttabs")) ?? [];
  }

  /** Returns the queued prefetch and batch open target counts shown in the popup badge. */
  async getnavqueues(): Promise<navqueues | undefined> {
    return this.adapter.get<navqueues>("navqueues");
  }

  /** Replaces the queued prefetch and batch open target counts. */
  async setnavqueues(queues: navqueues): Promise<void> {
  ...
  async getnavstate(tabid: number): Promise<navrecord | undefined> {
    return this.adapter.get<navrecord>(`navstate${tabid}`);
  }

  /** Replaces the last known navigation state of a tab. */
  async setnavstate(tabid: number, state: navrecord): Promise<void> {
  ...
  async getlayout(name: string): Promise<tablayout | undefined> {
  ...
  async getlayouts(): Promise<tablayout[]> {
    return (await this.adapter.get<tablayout[]>("layouts")) ?? [];
  }
  ...
  async gettabgroups(): Promise<tabgrouprecord[]> {
    return (await this.adapter.get<tabgrouprecord[]>("tabgroups")) ?? [];
  }
  ...
  async gettabmetas(): Promise<tabmeta[]> {
    return (await this.adapter.get<tabmeta[]>("tabmetas")) ?? [];
  }
  ...
  async getsnapshots(): Promise<sessionsnapshot[]> {
    return (await this.adapter.get<sessionsnapshot[]>("snapshots")) ?? [];
  }
  ...
  async getclosedtabs(): Promise<closedtab[]> {
    return (await this.adapter.get<closedtab[]>("closedtabs")) ?? [];
  }
  ...
  async getbadges(): Promise<tabbadge[]> {
    return (await this.adapter.get<tabbadge[]>("badges")) ?? [];
  }
  ...
  async gettabwatchevents(): Promise<tabwatchevent[]> {
    return (await this.adapter.get<tabwatchevent[]>("tabwatchevents")) ?? [];
  }

  /** Returns the ids of the scratch windows opened for split work. */
  async getscratchwindows(): Promise<number[]> {
    return (await this.adapter.get<number[]>("scratchwindows")) ?? [];
  }

  /** Replaces the scratch window id list after one scratch window opens or closes. */
  async setscratchwindows(ids: number[]): Promise<void> {
    return this.adapter.set("scratchwindows", ids);
  }

  /** Returns the pinned control tab state with the live task feed. */
  async getcontroltab(): Promise<controltabstate | undefined> {
    return this.adapter.get<controltabstate>("controltab");
  }

  /** Replaces the pinned control tab state. */
  async setcontroltab(state: controltabstate): Promise<void> {
  ...
  async getprofile(name: string): Promise<formprofile | undefined> {
  ...
  async getprofiles(): Promise<formprofile[]> {
    return (await this.adapter.get<formprofile[]>("formprofiles")) ?? [];
  }
  ...
  async getwizards(): Promise<wizardstate[]> {
    return (await this.adapter.get<wizardstate[]>("wizards")) ?? [];
  }
  ...
  async gettickets(): Promise<submitticket[]> {
    return (await this.adapter.get<submitticket[]>("submittickets")) ?? [];
  }
  ...
  async geterrorreports(): Promise<errorreport[]> {
    return (await this.adapter.get<errorreport[]>("errorreports")) ?? [];
  }
  ...
  async getpicks(): Promise<typeaheadpick[]> {
    return (await this.adapter.get<typeaheadpick[]>("typeaheadpicks")) ?? [];
  }
  ...
  async getcaptchas(): Promise<captchahandoff[]> {
    return (await this.adapter.get<captchahandoff[]>("captchas")) ?? [];
  }
  ...
  async resolvecaptcha(id: string, resolvedat: number): Promise<void> {
    ...
    await this.adapter.set(
      "captchas",
      records.map((handoff) =>
        handoff.id === id && !handoff.resolved ? { ...handoff, resolved: true, resolvedat } : handoff,
      ),
    );
  }
  ...
  async getdetections(): Promise<detectionrecord[]> {
    return (await this.adapter.get<detectionrecord[]>("detections")) ?? [];
  }

  /** Stores the reviewed one time code behind the consent gate of an active session. */
  async setcodevalue(value: string): Promise<void> {
  ...
  async getcodevalue(): Promise<string | undefined> {
    return this.adapter.get<string>("codevalue");
  }
  ...
  async getdataset(id: string): Promise<dataset | undefined> {
    return this.adapter.get<dataset>(`dataset${id}`);
  }
  ...
  async getprovenances(): Promise<provenancerecord[]> {
    return (await this.adapter.get<provenancerecord[]>("provenances")) ?? [];
  }
  ...
  async settaskrules(value: taskrules): Promise<void> {
    const records = ((await this.adapter.get<taskrules[]>("taskrules")) ?? []).filter(
      (item) => item.taskid !== value.taskid,
    );
  ...
  async gettaskrules(): Promise<taskrules[]> {
    return (await this.adapter.get<taskrules[]>("taskrules")) ?? [];
  }
  ...
  async setstream(state: streamstate): Promise<void> {
    const records = ((await this.adapter.get<streamstate[]>("streams")) ?? []).filter(
      (item) => item.datasetid !== state.datasetid,
    );
    await this.adapter.set("streams", [state, ...records]);
  }

  /** Returns every stream chunk state persisted for resume, newest first. */
  async getstreams(): Promise<streamstate[]> {
    return (await this.adapter.get<streamstate[]>("streams")) ?? [];
  }
  ...
  async setsheetendpoint(config: sheetendpoint): Promise<void> {
    const records = ((await this.adapter.get<sheetendpoint[]>("sheetendpoints")) ?? []).filter(
      (item) => item.origin !== config.origin,
    );
    await this.adapter.set("sheetendpoints", [config, ...records]);
  }

  /** Returns every reviewed sheet endpoint config, newest first. */
  async getsheetendpoints(): Promise<sheetendpoint[]> {
    return (await this.adapter.get<sheetendpoint[]>("sheetendpoints")) ?? [];
  }
  ...
  async getexports(): Promise<exportedartifact[]> {
    return (await this.adapter.get<exportedartifact[]>("exports")) ?? [];
  }
  ...
  async setdownload(record: downloadrecord): Promise<void> {
    const records = ((await this.adapter.get<downloadrecord[]>("downloads")) ?? []).filter(
  ...
  async getdownloads(): Promise<downloadrecord[]> {
    return (await this.adapter.get<downloadrecord[]>("downloads")) ?? [];
  }
  ...
  async getnetlog(): Promise<netlogrecord[]> {
    return (await this.adapter.get<netlogrecord[]>("netlog")) ?? [];
  }
  ...
  async setclipconsent(record: clipboardconsentrecord): Promise<void> {
    const records = ((await this.adapter.get<clipboardconsentrecord[]>("clipconsents")) ?? []).filter(
      (item) => item.id !== record.id,
    );
  ...
  async getclipconsents(): Promise<clipboardconsentrecord[]> {
    return (await this.adapter.get<clipboardconsentrecord[]>("clipconsents")) ?? [];
  }
  ...
  async getclips(): Promise<clipentry[]> {
    return (await this.adapter.get<clipentry[]>("clips")) ?? [];
  }
  ...
  async setquarantine(entry: quarantineentry): Promise<void> {
    const records = ((await this.adapter.get<quarantineentry[]>("quarantines")) ?? []).filter(
  ...
  async getquarantines(): Promise<quarantineentry[]> {
    return (await this.adapter.get<quarantineentry[]>("quarantines")) ?? [];
  }

  /** Stores the reviewed cleanup rule set of the run, replacing the previous set. */
  async setcleanuprules(rules: cleanuprule[]): Promise<void> {
  ...
  async getcleanuprules(): Promise<cleanuprule[]> {
    return (await this.adapter.get<cleanuprule[]>("cleanuprules")) ?? [];
  }
  ...
  async getcleanupruns(): Promise<cleanuprun[]> {
    return (await this.adapter.get<cleanuprun[]>("cleanupruns")) ?? [];
  }
  ...
  async setcapturecounter(counter: capturecounter): Promise<void> {
    const records = ((await this.adapter.get<capturecounter[]>("capturecounters")) ?? []).filter(
      (item) => item.taskid !== counter.taskid,
    );
    await this.adapter.set("capturecounters", [counter, ...records]);
  }

  /** Returns every stored capture naming counter per task, newest first. */
  async getcapturecounters(): Promise<capturecounter[]> {
    return (await this.adapter.get<capturecounter[]>("capturecounters")) ?? [];
  }

  /** Replaces the artifact inventory the cleanup sweeper plans against. */
  async setinventory(entries: artifactinventoryentry[]): Promise<void> {
    return this.adapter.set("inventory", entries);
  }

  /** Returns the artifact inventory with sizes and ages for the cleanup sweeper. */
  async getinventory(): Promise<artifactinventoryentry[]> {
    return (await this.adapter.get<artifactinventoryentry[]>("inventory")) ?? [];
  }
  ...
  async setscanhook(config: scanhookconfig): Promise<void> {
    const records = ((await this.adapter.get<scanhookconfig[]>("scanhooks")) ?? []).filter(
      (item) => item.scanner !== config.scanner,
    );
    await this.adapter.set("scanhooks", [config, ...records]);
  }

  /** Returns every configured virus scanning hook, newest first. */
  async getscanhooks(): Promise<scanhookconfig[]> {
    return (await this.adapter.get<scanhookconfig[]>("scanhooks")) ?? [];
  }

  /** Stores the armed mime interception filters of the run, newest first. */
  async setmimefilters(filters: mimefilter[]): Promise<void> {
    return this.adapter.set("mimefilters", filters);
  }

  /** Returns the armed mime interception filters of the run, newest first. */
  async getmimefilters(): Promise<mimefilter[]> {
    return (await this.adapter.get<mimefilter[]>("mimefilters")) ?? [];
  }
  ...
  async addcapture(record: shotrecord): Promise<void> {
    ...
    const stored =
      retention === undefined
        ? combined
        : combined.map((item, index) => (index < retention ? item : expirecapturebytes(item)));
    await this.adapter.set("captures", stored);
  }

  /** Returns every stored capture record with its metadata, newest first. */
  async getcaptures(): Promise<shotrecord[]> {
    return (await this.adapter.get<shotrecord[]>("captures")) ?? [];
  }

  /** Returns one capture record with its bytes by its id. */
  async getcapture(id: string): Promise<shotrecord | undefined> {
  ...
  async listcaptures(filter: { runid?: string; stepid?: string; kind?: string }): Promise<shotrecord[]> {
    ...
    return records.filter(
      (item) =>
        ...
        (filter.stepid === undefined || item.stepid === filter.stepid) &&
  ...
  async addmedia(record: mediarecord): Promise<void> {
    ...
    const stored =
      retention === undefined
        ? combined
        : combined.map((item, index) => (index < retention ? item : expiremediabytes(item)));
    await this.adapter.set("media", stored);
  }

  /** Returns every stored media record, newest first. */
  async getmediarecords(): Promise<mediarecord[]> {
    return (await this.adapter.get<mediarecord[]>("media")) ?? [];
  }
  ...
  async listmedia(filter: { runid?: string; kind?: string }): Promise<mediarecord[]> {
    ...
    return records.filter(
      (item) =>
        (filter.runid === undefined || item.runid === filter.runid) &&
        (filter.kind === undefined || mediakindof(item) === filter.kind),
    );
  }

  /** Returns one media record by its id. */
  async getmediarecord(id: string): Promise<mediarecord | undefined> {
  ...
  async removemedia(id: string): Promise<void> {
    await this.adapter.set(
      "media",
      (await this.getmediarecords()).filter((item) => item.id !== id),
    );
  }
  ...
  async getimagebatches(): Promise<imagebatch[]> {
    return (await this.adapter.get<imagebatch[]>("imagebatches")) ?? [];
  }
  ...
  async setrecordingconsent(record: recordingconsentrecord): Promise<void> {
    const records = ((await this.adapter.get<recordingconsentrecord[]>("recordingconsents")) ?? []).filter(
      (item) => item.id !== record.id,
    );
  ...
  async getrecordingconsents(): Promise<recordingconsentrecord[]> {
    return (await this.adapter.get<recordingconsentrecord[]>("recordingconsents")) ?? [];
  }
  ...
  async addcall(record: callrecord): Promise<void> {
    ...
    const stored =
      retention === undefined
        ? combined
        : combined.map((item, index) => (index < retention ? item : expirecallbody(item)));
  ...
  async getcalls(): Promise<callrecord[]> {
    return (await this.adapter.get<callrecord[]>("calls")) ?? [];
  }

  /** Returns one outbound call record with its body by its id. */
  async getcall(id: string): Promise<callrecord | undefined> {
  ...
  async listcalls(filter: { runid?: string; origin?: string }): Promise<callrecord[]> {
    ...
    return records.filter(
      (item) =>
        (filter.runid === undefined || item.runid === filter.runid) &&
        (filter.origin === undefined || item.origin === filter.origin),
    );
  }
  ...
  async setfetchconsent(consent: fetchconsent): Promise<void> {
    const records = ((await this.adapter.get<fetchconsent[]>("fetchconsents")) ?? []).filter(
  ...
  async getfetchconsents(): Promise<fetchconsent[]> {
    return (await this.adapter.get<fetchconsent[]>("fetchconsents")) ?? [];
  }
  ...
  async setapikey(entry: apikeyentry): Promise<void> {
    const records = ((await this.adapter.get<apikeyentry[]>("apikeys")) ?? []).filter(
  ...
  async getapikeys(): Promise<apikeyentry[]> {
    return (await this.adapter.get<apikeyentry[]>("apikeys")) ?? [];
  }
  ...
  async setsecret(storageid: string, value: string): Promise<void> {
    return this.adapter.set(storageid, value);
  }

  /** Loads one api key secret under its storage id for the executor only. */
  async getsecret(storageid: string): Promise<string | undefined> {
    return this.adapter.get<string>(storageid);
  }
  ...
  async addchannel(record: channelrecord): Promise<void> {
    const records = ((await this.adapter.get<channelrecord[]>("channels")) ?? []).filter(
      (item) => item.id !== record.id,
    );
  ...
  async getchannels(): Promise<channelrecord[]> {
    return (await this.adapter.get<channelrecord[]>("channels")) ?? [];
  }
  ...
  async addmessage(envelope: messageenvelope): Promise<void> {
    const records = ((await this.adapter.get<messageenvelope[]>("messages")) ?? []).filter(
      (item) => !(item.channelid === envelope.channelid && item.sequence === envelope.sequence),
    );
  ...
  async getmessages(channelid?: string, stream?: string): Promise<messageenvelope[]> {
    ...
    return records.filter(
      (item) =>
        (channelid === undefined || item.channelid === channelid) && (stream === undefined || item.stream === stream),
    );
  }
  ...
  async drainmessages(sequences: Array<{ channelid: string; sequence: number }>): Promise<void> {
    ...
    const kept = records.filter(
      (item) => !sequences.some((match) => match.channelid === item.channelid && match.sequence === item.sequence),
    );
  ...
  async addexchange(record: exchangerecord): Promise<void> {
    const records = ((await this.adapter.get<exchangerecord[]>("exchanges")) ?? []).filter(
      (item) => item.id !== record.id,
    );
  ...
  async getexchanges(): Promise<exchangerecord[]> {
    return (await this.adapter.get<exchangerecord[]>("exchanges")) ?? [];
  }

  /** Returns one exchange record by its id. */
  async getexchange(id: string): Promise<exchangerecord | undefined> {
    ...
    return records.filter(
      (item) =>
        ...
        (filter.status === undefined ||
          (filter.status === "failed" ? item.errorclass !== undefined : item.status === filter.status)),
    );
  }
  ...
  async addbody(record: bodyrecord): Promise<void> {
    ...
    const stored =
      retention === undefined
        ? combined
        : combined.map((item, index) => (index < retention ? item : expirebodybytes(item)));
    await this.adapter.set("bodies", stored);
  }

  /** Returns every captured body record, newest first. */
  async getbodies(): Promise<bodyrecord[]> {
    return (await this.adapter.get<bodyrecord[]>("bodies")) ?? [];
  }

  /** Returns one captured body record with its stored text by its reference. */
  async getbody(ref: string): Promise<bodyrecord | undefined> {
  ...
  async getapimap(): Promise<apimapentry[]> {
    return (await this.adapter.get<apimapentry[]>("apimap")) ?? [];
  }
  ...
  async setsubscription(record: eventsubscription): Promise<void> {
    const records = ((await this.adapter.get<eventsubscription[]>("subscriptions")) ?? []).filter(
      (item) => item.id !== record.id,
    );
  ...
  async getsubscriptions(): Promise<eventsubscription[]> {
    return (await this.adapter.get<eventsubscription[]>("subscriptions")) ?? [];
  }
  ...
  async getblockrules(): Promise<blockrule[]> {
    return (await this.adapter.get<blockrule[]>("blockrules")) ?? [];
  }
  ...
  async getmockspecs(): Promise<mockspec[]> {
    return (await this.adapter.get<mockspec[]>("mockspecs")) ?? [];
  }
  ...
  async getheaderules(): Promise<headerule[]> {
    return (await this.adapter.get<headerule[]>("headerules")) ?? [];
  }
  ...
  async addproxyroute(route: proxyroute): Promise<void> {
    const records = ((await this.adapter.get<proxyroute[]>("proxyroutes")) ?? []).filter(
  ...
  async getproxyroutes(): Promise<proxyroute[]> {
    return (await this.adapter.get<proxyroute[]>("proxyroutes")) ?? [];
  }
  ...
  async setratelimit(read: ratelimitread): Promise<void> {
    const records = ((await this.adapter.get<ratelimitread[]>("ratelimits")) ?? []).filter(
      (item) => item.origin !== read.origin,
    );
  ...
  async gettimeline(): Promise<timelineentry[]> {
    return (await this.adapter.get<timelineentry[]>("timelineentries")) ?? [];
  }
  ...
  async listtimeline(filter: { runid?: string; level?: loglevel; stepid?: string }): Promise<timelineentry[]> {
    ...
    return records.filter(
      (item) =>
        (filter.runid === undefined || item.runid === filter.runid) &&
        (filter.level === undefined || item.level === filter.level) &&
        (filter.stepid === undefined || item.stepid === filter.stepid),
    );
  }
  ...
  async geterrorrecords(): Promise<errorrecord[]> {
    return (await this.adapter.get<errorrecord[]>("errorrecords")) ?? [];
  }
  ...
  async getrejectionrecords(): Promise<rejectionrecord[]> {
    return (await this.adapter.get<rejectionrecord[]>("rejectionrecords")) ?? [];
  }
  ...
  async getlongtasks(): Promise<longtaskentry[]> {
    return (await this.adapter.get<longtaskentry[]>("longtasks")) ?? [];
  }

  /** Stores one console diff result between two runs, replacing the previous one. */
  async addconsolediff(diff: consolediff): Promise<void> {
    return this.adapter.set("consolediff", diff);
  }

  /** Returns the one stored console diff result. */
  async getdiff(): Promise<consolediff | undefined> {
    return this.adapter.get<consolediff>("consolediff");
  }
  ...
  async addrotationtarget(record: rotationtargetrecord): Promise<void> {
    const records = ((await this.adapter.get<rotationtargetrecord[]>("rotationtargets")) ?? []).filter(
      (item) => !(item.target === record.target && item.runid === record.runid),
    );
  ...
  async getrotationtargets(): Promise<rotationtargetrecord[]> {
    return (await this.adapter.get<rotationtargetrecord[]>("rotationtargets")) ?? [];
  }
  ...
  async setconsoleconsent(consent: consoleconsentrecord): Promise<void> {
    const records = ((await this.adapter.get<consoleconsentrecord[]>("consoleconsents")) ?? []).filter(
      (item) => item.id !== consent.id,
    );
  ...
  async getconsoleconsents(): Promise<consoleconsentrecord[]> {
    return (await this.adapter.get<consoleconsentrecord[]>("consoleconsents")) ?? [];
  }
  ...
  async setcdpsession(session: cdpsession): Promise<void> {
    const records = ((await this.adapter.get<cdpsession[]>("cdpsessions")) ?? []).filter(
  ...
  async getcdpsessions(): Promise<cdpsession[]> {
    return (await this.adapter.get<cdpsession[]>("cdpsessions")) ?? [];
  }
  ...
  async getcdpcommands(): Promise<cdpcommand[]> {
    return (await this.adapter.get<cdpcommand[]>("cdpcommands")) ?? [];
  }
  ...
  async setcdpeventrule(rule: cdpeventrule): Promise<void> {
    const records = ((await this.adapter.get<cdpeventrule[]>("cdpeventrules")) ?? []).filter(
  ...
  async getcdpeventrules(): Promise<cdpeventrule[]> {
    return (await this.adapter.get<cdpeventrule[]>("cdpeventrules")) ?? [];
  }
  ...
  async addbreakpoint(spec: breakpointspec): Promise<void> {
    const records = ((await this.adapter.get<breakpointspec[]>("breakpoints")) ?? []).filter(
  ...
  async getbreakpoints(): Promise<breakpointspec[]> {
    return (await this.adapter.get<breakpointspec[]>("breakpoints")) ?? [];
  }
  ...
  async getpauses(): Promise<pausestate[]> {
    return (await this.adapter.get<pausestate[]>("pauses")) ?? [];
  }
  ...
  async setwatchexpression(expression: watchexpression): Promise<void> {
    const records = ((await this.adapter.get<watchexpression[]>("watchexpressions")) ?? []).filter(
  ...
  async getwatchexpressions(): Promise<watchexpression[]> {
    return (await this.adapter.get<watchexpression[]>("watchexpressions")) ?? [];
  }
  ...
  async addscriptoverride(spec: scriptoverride): Promise<void> {
    const records = ((await this.adapter.get<scriptoverride[]>("scriptoverrides")) ?? []).filter(
      (item) => item.id !== spec.id,
    );
  ...
  async getscriptoverrides(): Promise<scriptoverride[]> {
    return (await this.adapter.get<scriptoverride[]>("scriptoverrides")) ?? [];
  }
  ...
  async setdebuggergrant(grant: debuggergrant): Promise<void> {
    const records = ((await this.adapter.get<debuggergrant[]>("debuggergrants")) ?? []).filter(
  ...
  async getdebuggergrants(): Promise<debuggergrant[]> {
    return (await this.adapter.get<debuggergrant[]>("debuggergrants")) ?? [];
  }
  ...
  async getlevelsummaries(): Promise<levelsummary[]> {
    return (await this.adapter.get<levelsummary[]>("levelsummaries")) ?? [];
  }
  ...
  async getflowmetrics(): Promise<flowmetric[]> {
    return (await this.adapter.get<flowmetric[]>("flowmetrics")) ?? [];
  }
  ...
  async setheaprecord(heap: heaprecord): Promise<void> {
    ...
    const { heaps } = expireprofilerecords({
      heaps: [heap, ...records],
      profiles: [],
      traces: [],
      retention,
  ...
  async getheaprecords(): Promise<heaprecord[]> {
    return (await this.adapter.get<heaprecord[]>("heaprecords")) ?? [];
  }
  ...
  async getgrowsamples(): Promise<growsample[]> {
    return (await this.adapter.get<growsample[]>("growsamples")) ?? [];
  }
  ...
  async gettrends(): Promise<memorytrend[]> {
    return (await this.adapter.get<memorytrend[]>("memorytrends")) ?? [];
  }
  ...
  async setcpuprofile(profile: cpuprofile): Promise<void> {
    const records = ((await this.adapter.get<cpuprofile[]>("cpuprofiles")) ?? []).filter(
      (item) => item.id !== profile.id,
    );
    const retention = (await this.getsettings())?.profileretention;
    const { profiles } = expireprofilerecords({
      heaps: [],
  ...
  async getcpuprofiles(): Promise<cpuprofile[]> {
    return (await this.adapter.get<cpuprofile[]>("cpuprofiles")) ?? [];
  }
  ...
  async getshiftentries(): Promise<shiftentry[]> {
    return (await this.adapter.get<shiftentry[]>("shiftentries")) ?? [];
  }
  ...
  async settracerecord(trace: tracerecord): Promise<void> {
    const records = ((await this.adapter.get<tracerecord[]>("tracerecords")) ?? []).filter(
      (item) => item.id !== trace.id,
    );
    const retention = (await this.getsettings())?.profileretention;
    const { traces } = expireprofilerecords({
      heaps: [],
      profiles: [],
  ...
  async gettracerecords(): Promise<tracerecord[]> {
    return (await this.adapter.get<tracerecord[]>("tracerecords")) ?? [];
  }
  ...
  async listtraces(filter: { runid?: string; categories?: string[] }): Promise<tracerecord[]> {
    ...
    return records.filter(
      (trace) =>
        (filter.runid === undefined || trace.runid === filter.runid) &&
        (filter.categories === undefined || filter.categories.every((category) => trace.categories.includes(category))),
    );
  }
  ...
  async settracefile(traceid: string, content: string): Promise<void> {
    const records = (
      (await this.adapter.get<Array<{ traceid: string; content: string; savedat: number }>>("tracefiles")) ?? []
    ).filter((item) => item.traceid !== traceid);
    const trace = (await this.gettracerecords()).find((item) => item.id === traceid);
    const retention = (await this.getsettings())?.profileretention;
    const kept =
      retention === undefined || trace === undefined || Date.now() - trace.endedat <= retention
        ? [{ traceid, content, savedat: Date.now() }, ...records]
        : records;
  ...
  async setsourcemapref(ref: sourcemapref): Promise<void> {
    const records = ((await this.adapter.get<sourcemapref[]>("sourcemaprefs")) ?? []).filter(
      (item) => item.id !== ref.id,
    );
  ...
  async getsourcemaps(): Promise<sourcemapref[]> {
    return (await this.adapter.get<sourcemapref[]>("sourcemaprefs")) ?? [];
  }
  ...
  async setsourcemapconsent(consent: sourcemapconsent): Promise<void> {
    const records = ((await this.adapter.get<sourcemapconsent[]>("sourcemapconsents")) ?? []).filter(
      (item) => item.id !== consent.id,
    );
  ...
  async getsourcemapconsents(): Promise<sourcemapconsent[]> {
    return (await this.adapter.get<sourcemapconsent[]>("sourcemapconsents")) ?? [];
  }
  ...
  async getemulationstate(runid: string): Promise<emulationstate | undefined> {
    return this.adapter.get<emulationstate>(`emulationstate${runid}`);
  }
  ...
  async setdevicepreset(preset: devicepreset): Promise<void> {
    const records = ((await this.adapter.get<devicepreset[]>("devicepresets")) ?? []).filter(
  ...
  async getdevicepresets(): Promise<devicepreset[]> {
    return (await this.adapter.get<devicepreset[]>("devicepresets")) ?? [];
  }
  ...
  async setnetworkpreset(preset: networkpreset): Promise<void> {
    const records = ((await this.adapter.get<networkpreset[]>("networkpresets")) ?? []).filter(
      (item) => item.name !== preset.name,
    );
  ...
  async getnetworkpresets(): Promise<networkpreset[]> {
    return (await this.adapter.get<networkpreset[]>("networkpresets")) ?? [];
  }

  /** Stores one user curated location preset by its name. */
  async setlocationpreset(preset: locationpreset): Promise<void> {
    const records = ((await this.adapter.get<locationpreset[]>("locationpresets")) ?? []).filter(
      (item) => item.name !== preset.name,
    );
  ...
  async getlocationpresets(): Promise<locationpreset[]> {
    return (await this.adapter.get<locationpreset[]>("locationpresets")) ?? [];
  }

  /** Stores one user curated agent preset by its name. */
  async setagentpreset(preset: agentpreset): Promise<void> {
    const records = ((await this.adapter.get<agentpreset[]>("agentpresets")) ?? []).filter(
      (item) => item.name !== preset.name,
    );
  ...
  async getagentpresets(): Promise<agentpreset[]> {
    return (await this.adapter.get<agentpreset[]>("agentpresets")) ?? [];
  }
  ...
  async setblackboxrules(origin: string, rules: blackboxrule[]): Promise<void> {
    const records = (
      (await this.adapter.get<Array<{ origin: string; rules: blackboxrule[] }>>("blackboxrules")) ?? []
  ...
  async getblackboxrules(): Promise<Array<{ origin: string; rules: blackboxrule[] }>> {
    return (await this.adapter.get<Array<{ origin: string; rules: blackboxrule[] }>>("blackboxrules")) ?? [];
  }
  ...
  async addpermissionoverride(record: permissionoverriderecord): Promise<void> {
    const records = ((await this.adapter.get<permissionoverriderecord[]>("permissionoverrides")) ?? []).filter(
      (item) => item.id !== record.id,
    );
  ...
  async getpermissionoverrides(): Promise<permissionoverriderecord[]> {
    return (await this.adapter.get<permissionoverriderecord[]>("permissionoverrides")) ?? [];
  }
  ...
  async setlocationconsent(consent: locationconsent): Promise<void> {
    const records = ((await this.adapter.get<locationconsent[]>("locationconsents")) ?? []).filter(
      (item) => item.id !== consent.id,
    );
  ...
  async getlocationconsents(): Promise<locationconsent[]> {
    return (await this.adapter.get<locationconsent[]>("locationconsents")) ?? [];
  }

  /** Returns the persisted task state checkpoint of one run so the run resumes after a service worker restart. */
  async gettaskstate(runid: string): Promise<taskstate | undefined> {
    return this.adapter.get<taskstate>(`taskstate${runid}`);
  }
  ...
  async getsessionevents(): Promise<sessionevent[]> {
    return (await this.adapter.get<sessionevent[]>("sessionevents")) ?? [];
  }
  ...
  async getsessionrecords(): Promise<sessionrecord[]> {
    return (await this.adapter.get<sessionrecord[]>("sessionrecords")) ?? [];
  }
  ...
  async getsessionfolders(): Promise<sessionfolder[]> {
    return (await this.adapter.get<sessionfolder[]>("sessionfolders")) ?? [];
  }

  /** Replaces the folder tree after a reviewed filing adds or moves one folder. */
  async setsessionfolders(folders: sessionfolder[]): Promise<void> {
    return this.adapter.set("sessionfolders", folders);
  }

  /** Returns every stored session diff result, newest first. */
  async getsessiondiffs(): Promise<sessiondiff[]> {
    return (await this.adapter.get<sessiondiff[]>("sessiondiffs")) ?? [];
  }
  ...
  async getautosnapshot(): Promise<autosnapshotstate | undefined> {
    return (await this.adapter.get<autosnapshotstate>("autosnapshot")) ?? undefined;
  }

  /** Stores the auto snapshot state of the reviewed interval. */
  async setautosnapshot(state: autosnapshotstate): Promise<void> {
  ...
  async clearautosnapshot(): Promise<void> {
    return this.adapter.set<autosnapshotstate | null>("autosnapshot", null);
  }
  ...
  async getcrashflag(): Promise<boolean> {
    return (await this.adapter.get<boolean>("crashed")) ?? false;
  }

  /** Sets the crash marker so the sessions view offers the crash restore inside the consent model. */
  async setcrashflag(value: boolean): Promise<void> {
  ...
  async getworkflowrecordversions(): Promise<workflowrecord[]> {
    return (await this.adapter.get<workflowrecord[]>("workflowrecords")) ?? [];
  }
  ...
  async listworkflowruns(): Promise<workflowrun[]> {
    return (await this.adapter.get<workflowrun[]>("workflowruns")) ?? [];
  }
  ...
  async getrunlog(runid: string): Promise<runlogentry[]> {
    return (await this.adapter.get<runlogentry[]>(`runlog${runid}`)) ?? [];
  }

  /** Stores the variable values per scope of one run for inspection after the run. */
  async setrunscopes(runid: string, scopes: variablescope[]): Promise<void> {
    return this.adapter.set(`runscopes${runid}`, scopes);
  }

  /** Returns the variable scopes of one run, oldest first. */
  async getrunscopes(runid: string): Promise<variablescope[]> {
    return (await this.adapter.get<variablescope[]>(`runscopes${runid}`)) ?? [];
  }
  ...
  async getworkflowprovenance(runid: string): Promise<workflowprovenance[]> {
    return (await this.adapter.get<workflowprovenance[]>(`workflowprovenance${runid}`)) ?? [];
  }
  ...
  async getsteptemplates(): Promise<steptemplate[]> {
    return (await this.adapter.get<steptemplate[]>("steptemplates")) ?? [];
  }
  ...
  async listcontroldecisions(runid: string): Promise<controlflowdecision[]> {
    return (await this.adapter.get<controlflowdecision[]>(`controldecisions${runid}`)) ?? [];
  }
  ...
  async getbranchhistory(workflowid: string): Promise<branchoutcome[]> {
    ...
    for (const run of ordered) {
      ...
      for (const decision of decisions)
        if (decision.kind === "branch" && decision.branch !== undefined) history.push(decision.branch);
    }
    return history;
  }
  ...
  async gettriggerules(): Promise<triggerule[]> {
    return (await this.adapter.get<triggerule[]>("triggerules")) ?? [];
  }

  /** Returns one armed trigger rule by its id. */
  async gettriggerule(id: string): Promise<triggerule | undefined> {
  ...
  async settriggerules(rules: triggerule[]): Promise<void> {
  ...
  async removetriggerule(id: string): Promise<void> {
    await this.adapter.set(
      "triggerules",
      (await this.gettriggerules()).filter((rule) => rule.id !== id),
    );
  }
  ...
  async listtriggers(): Promise<Array<{ rule: triggerule; workflowname?: string }>> {
    ...
    return rules.map((rule) => ({
      rule,
      ...(names.has(rule.workflowid) ? { workflowname: names.get(rule.workflowid) as string } : {}),
    }));
  }
  ...
  async settriggerqueue(queue: triggerfire[]): Promise<void> {
    return this.adapter.set("triggerqueue", queue);
  }

  /** Returns the pending trigger queue, oldest first. */
  async gettriggerqueue(): Promise<triggerfire[]> {
    return (await this.adapter.get<triggerfire[]>("triggerqueue")) ?? [];
  }
  ...
  async addwebhookpayload(ruleid: string, payload: Record<string, unknown>, at: number): Promise<void> {
    const stored =
      (await this.adapter.get<Array<{ ruleid: string; payload: Record<string, unknown>; at: number }>>(
        "webhookpayloads",
      )) ?? [];
  ...
  async listwebhookpayloads(
    ruleid: string,
  ): Promise<Array<{ ruleid: string; payload: Record<string, unknown>; at: number }>> {
    const stored =
      (await this.adapter.get<Array<{ ruleid: string; payload: Record<string, unknown>; at: number }>>(
        "webhookpayloads",
      )) ?? [];
  ...
  async listmanualruns(): Promise<manualrun[]> {
    return (await this.adapter.get<manualrun[]>("manualruns")) ?? [];
  }
  ...
  async addworkflowversion(version: workflowversion): Promise<void> {
    const versions = (await this.listworkflowversions()).filter(
      (entry) => !(entry.workflowid === version.workflowid && entry.version === version.version),
    );
  ...
  async addversiondiff(diff: versiondiff): Promise<void> {
    const diffs = (await this.listversiondiffs()).filter(
      (entry) => !(entry.workflowid === diff.workflowid && entry.from === diff.from && entry.to === diff.to),
    );
  ...
  async seteditorlayout(workflowid: string, layout: editorlayout): Promise<void> {
    return this.adapter.set(`editorlayout${workflowid}`, layout);
  }

  /** Returns the stored editor layout of one workflow. */
  async geteditorlayout(workflowid: string): Promise<editorlayout | undefined> {
    return (await this.adapter.get<editorlayout>(`editorlayout${workflowid}`)) ?? undefined;
  }

  /** Stores the breakpoint step ids of one workflow. */
  async setworkflowbreakpoints(workflowid: string, stepids: string[]): Promise<void> {
  ...
  async getworkflowbreakpoints(workflowid: string): Promise<string[]> {
    return (await this.adapter.get<string[]>(`workflowbreakpoints${workflowid}`)) ?? [];
  }
  ...
  async removesiteoverride(id: string): Promise<void> {
    await this.adapter.set(
      "siteoverrides",
      (await this.listsiteoverrides()).filter((entry) => entry.id !== id),
    );
  }
  ...
  async listwatchdogevents(): Promise<watchdogrecord[]> {
    return (await this.adapter.get<watchdogrecord[]>("watchdogevents")) ?? [];
  }
  ...
  async listworkflowimports(): Promise<workflowimport[]> {
    return (await this.adapter.get<workflowimport[]>("workflowimports")) ?? [];
  }
  ...
  async removeworkflowimport(id: string): Promise<void> {
    await this.adapter.set(
      "workflowimports",
      (await this.listworkflowimports()).filter((entry) => entry.id !== id),
    );
  }

  /** Stores the per workflow background run flags so a workflow keeps running with the panel closed. */
  async setbackgroundruns(flags: Record<string, boolean>): Promise<void> {
    return this.adapter.set("backgroundruns", flags);
  }

  /** Returns the per workflow background run flags. */
  async getbackgroundruns(): Promise<Record<string, boolean>> {
    return (await this.adapter.get<Record<string, boolean>>("backgroundruns")) ?? {};
  }
  ...
  async removeworkflowversion(id: string, version: number): Promise<void> {
    await this.adapter.set(
      "workflowrecords",
      (await this.getworkflowrecordversions()).filter((entry) => !(entry.id === id && entry.version === version)),
    );
  }

  /** Returns every stored mcp client record, newest first. */
  async getclients(): Promise<clientrecord[]> {
    return (await this.adapter.get<clientrecord[]>("mcpclients")) ?? [];
  }
  ...
  async listclients(): Promise<clientrecord[]> {
    return (await this.getclients()).filter((client) => client.disconnectedat === undefined);
  }
  ...
  async setclientcapabilities(id: string, capabilities: capabilityset): Promise<void> {
    await this.adapter.set(
      "mcpclients",
      (await this.getclients()).map((client) => (client.id === id ? { ...client, capabilities } : client)),
    );
  }
  ...
  async addbridgelaunch(launch: bridgelaunch): Promise<void> {
    await this.adapter.set("mcbridgelaunches", [
      launch,
      ...((await this.adapter.get<bridgelaunch[]>("mcbridgelaunches")) ?? []),
    ]);
  }

  /** Returns every stdio bridge launch event, newest first. */
  async listbridgelaunches(): Promise<bridgelaunch[]> {
    return (await this.adapter.get<bridgelaunch[]>("mcbridgelaunches")) ?? [];
  }

  /** Returns the user configured mcp server config; an absent record keeps the documented localhost default. */
  async getmcpconfig(): Promise<mcpserverconfig | undefined> {
    return this.adapter.get<mcpserverconfig>("mcpconfig");
  }
  ...
  async setmcpconfig(config: mcpserverconfig): Promise<void> {
    return this.adapter.set("mcpconfig", config);
  }

  /** Returns the persisted mcp server runtime state. */
  async getmcpstate(): Promise<mcpserverstate | undefined> {
    return this.adapter.get<mcpserverstate>("mcpstate");
  }

  /** Stores the mcp server runtime state with the stdio bridge status. */
  async setmcpstate(state: mcpserverstate): Promise<void> {
  ...
  async addtoolcall(record: toolcallrecord): Promise<void> {
    ...
    await this.adapter.set(
      "mcptoolcalls",
      retention === undefined ? [record, ...records] : [record, ...records].slice(0, retention),
    );
  }

  /** Returns every stored mcp tool call record, newest first. */
  async listtoolcalls(): Promise<toolcallrecord[]> {
    return (await this.adapter.get<toolcallrecord[]>("mcptoolcalls")) ?? [];
  }
  ...
  async getsessiontokens(): Promise<sessiontoken[]> {
    return (await this.adapter.get<sessiontoken[]>("mcpsessiontokens")) ?? [];
  }

  /** Replaces the stored session token set after one issue, revocation or expiry sweep. */
  async setsessiontokens(tokens: sessiontoken[]): Promise<void> {
    return this.adapter.set("mcpsessiontokens", tokens);
  }

  /** Returns every stored pairing code with its single use state, newest first. */
  async getpairingcodes(): Promise<pairingcode[]> {
    return (await this.adapter.get<pairingcode[]>("mcppairingcodes")) ?? [];
  }

  /** Records one issued pairing code for the one time client pairing. */
  async addpairingcode(code: pairingcode): Promise<void> {
    return this.adapter.set("mcppairingcodes", [
      code,
      ...(await this.getpairingcodes()).filter((candidate) => candidate.code !== code.code),
    ]);
  }
  ...
  async usepairingcode(code: string, now: number): Promise<void> {
    await this.adapter.set(
      "mcppairingcodes",
      (await this.getpairingcodes()).map((candidate) =>
        candidate.code === code ? { ...candidate, usedat: now } : candidate,
      ),
    );
  }
  ...
  async getallowlist(): Promise<allowlistentry[]> {
    return (await this.adapter.get<allowlistentry[]>("mcpallowlist")) ?? [];
  }
  ...
  async setallowlistentry(entry: allowlistentry): Promise<void> {
    await this.adapter.set("mcpallowlist", [
      entry,
      ...(await this.getallowlist()).filter((candidate) => candidate.fingerprint !== entry.fingerprint),
    ]);
  }
  ...
  async removeallowlistentry(fingerprint: string): Promise<void> {
    await this.adapter.set(
      "mcpallowlist",
      (await this.getallowlist()).filter((entry) => entry.fingerprint !== fingerprint),
    );
  }

  /** Returns every approval gate with its decision state — the pending and resolved gates of the approval view. */
  async listapprovals(): Promise<approvalrequest[]> {
    return (await this.adapter.get<approvalrequest[]>("mcpapprovals")) ?? [];
  }
  ...
  async setapproval(request: approvalrequest): Promise<void> {
    await this.adapter.set("mcpapprovals", [
      request,
      ...(await this.listapprovals()).filter((candidate) => candidate.id !== request.id),
    ]);
  }

  /** Records one approval execution — the decision, the actor, the time and the latency — beside its gate. */
  async addapprovalexec(exec: approvalexec): Promise<void> {
    return this.adapter.set("mcpapprovalexecs", [
      exec,
      ...((await this.adapter.get<approvalexec[]>("mcpapprovalexecs")) ?? []),
    ]);
  }

  /** Returns every approval execution record, newest first. */
  async listapprovalexecs(): Promise<approvalexec[]> {
    return (await this.adapter.get<approvalexec[]>("mcpapprovalexecs")) ?? [];
  }

  /** Records one auth handshake event with its issued, verified or refused outcome. */
  async addauthhandshake(event: authhandshakeevent): Promise<void> {
    return this.adapter.set("mcpauthhandshakes", [
      event,
      ...((await this.adapter.get<authhandshakeevent[]>("mcpauthhandshakes")) ?? []),
    ]);
  }

  /** Returns every auth handshake event with its outcome, newest first. */
  async listauthhandshakes(): Promise<authhandshakeevent[]> {
    return (await this.adapter.get<authhandshakeevent[]>("mcpauthhandshakes")) ?? [];
  }

  /** Returns every stored client identity with its fingerprint for allowlist matching. */
  async getclientidentities(): Promise<clientidentity[]> {
    return (await this.adapter.get<clientidentity[]>("mcpidentities")) ?? [];
  }
  ...
  async setclientidentity(identity: clientidentity): Promise<void> {
    await this.adapter.set("mcpidentities", [
      identity,
      ...(await this.getclientidentities()).filter((candidate) => candidate.fingerprint !== identity.fingerprint),
    ]);
  }

  /** Returns every open and closed stream channel of the http stream transport. */
  async getstreamchannels(): Promise<streamchannel[]> {
    return (await this.adapter.get<streamchannel[]>("mcpchannels")) ?? [];
  }

  /** Replaces the stored stream channel set after one open, heartbeat or close sweep. */
  async setstreamchannels(channels: streamchannel[]): Promise<void> {
  ...
  async geteventsubscriptions(): Promise<protocoleventsubscription[]> {
    return (await this.adapter.get<protocoleventsubscription[]>("mcpeventsubscriptions")) ?? [];
  }

  /** Replaces the stored event subscription set after one subscribe, unsubscribe or delivery sweep. */
  async seteventsubscriptions(subscriptions: protocoleventsubscription[]): Promise<void> {
  ...
  async getresourcewatches(): Promise<resourcewatch[]> {
    return (await this.adapter.get<resourcewatch[]>("mcpresourcewatches")) ?? [];
  }

  /** Replaces the stored resource watcher set after one watch, unwatch or delta push. */
  async setresourcewatches(watches: resourcewatch[]): Promise<void> {
    return this.adapter.set("mcpresourcewatches", watches);
  }

  /** Returns every sampling request with its provenance, newest first. */
  async getsamplingrequests(): Promise<samplingrequest[]> {
    return (await this.adapter.get<samplingrequest[]>("mcpsampling")) ?? [];
  }

  /** Replaces the stored sampling request set after one request or answer. */
  async setsamplingrequests(requests: samplingrequest[]): Promise<void> {
    return this.adapter.set("mcpsampling", requests);
  }

  /** Returns every stored idempotency record for replay, newest first. */
  async getidempotencyrecords(): Promise<idempotencyrecord[]> {
    return (await this.adapter.get<idempotencyrecord[]>("mcpidempotency")) ?? [];
  }

  /** Replaces the stored idempotency record set after one store or expiry sweep. */
  async setidempotencyrecords(records: idempotencyrecord[]): Promise<void> {
    return this.adapter.set("mcpidempotency", records);
  }

  /** Returns every per client rate limit counter with its window and budget. */
  async getcallratelimits(): Promise<callratelimit[]> {
    return (await this.adapter.get<callratelimit[]>("mcpcallratelimits")) ?? [];
  }

  /** Replaces the stored per client rate limit set after one configuration or counted call. */
  async setcallratelimits(limits: callratelimit[]): Promise<void> {
  ...
  async getbatchcalls(): Promise<batchcall[]> {
    return (await this.adapter.get<batchcall[]>("mcpbatchcalls")) ?? [];
  }
  ...
  async setbatchcall(batch: batchcall): Promise<void> {
    await this.adapter.set("mcpbatchcalls", [
      batch,
      ...(await this.getbatchcalls()).filter((candidate) => candidate.id !== batch.id),
    ]);
  }

  /** Returns every call context of the call runtime, newest first. */
  async getcallcontexts(): Promise<callcontext[]> {
    return (await this.adapter.get<callcontext[]>("mcpcallcontexts")) ?? [];
  }

  /** Replaces the stored call context set after one begin, end or cancellation. */
  async setcallcontexts(contexts: callcontext[]): Promise<void> {
    return this.adapter.set("mcpcallcontexts", contexts);
  }

  /** Returns every stored tool mock for client testing. */
  async gettoolmocks(): Promise<toolmock[]> {
    return (await this.adapter.get<toolmock[]>("mcptoolmocks")) ?? [];
  }
  ...
  async settoolmock(mock: toolmock): Promise<void> {
    await this.adapter.set("mcptoolmocks", [
      mock,
      ...(await this.gettoolmocks()).filter((candidate) => candidate.tool !== mock.tool),
    ]);
  }
  ...
  async removetoolmock(tool: string): Promise<void> {
    await this.adapter.set(
      "mcptoolmocks",
      (await this.gettoolmocks()).filter((candidate) => candidate.tool !== tool),
    );
  }
  ...
  async getstreamchunks(): Promise<streamchunk[]> {
    return (await this.adapter.get<streamchunk[]>("mcpstreamchunks")) ?? [];
  }

  /** Replaces the recent stream chunk window after one streaming sweep. */
  async setstreamchunks(chunks: streamchunk[]): Promise<void> {
  ...
  async getprogressnotices(): Promise<progressnotice[]> {
    return (await this.adapter.get<progressnotice[]>("mcpprogressnotices")) ?? [];
  }

  /** Returns the tool dry run toggle of the next call: true once the user armed the dry run in the panel. */
  async getdryruntoggle(): Promise<boolean> {
    return (await this.adapter.get<boolean>("mcpdryruntoggle")) === true;
  }

  /** Arms or disarms the tool dry run of the next call. */
  async setdryruntoggle(enabled: boolean): Promise<void> {
  ...
  async getclientbindings(): Promise<clientbinding[]> {
    return (await this.adapter.get<clientbinding[]>("mcpclientbindings")) ?? [];
  }

  /** Replaces the stored client binding set after one bind or release; the released records stay for the audit trail. */
  async setclientbindings(bindings: clientbinding[]): Promise<void> {
  ...
  async setclientbinding(binding: clientbinding): Promise<void> {
    await this.adapter.set("mcpclientbindings", [
      binding,
      ...(await this.getclientbindings()).filter((candidate) => candidate.clientid !== binding.clientid),
    ]);
  }
  ...
  async getdrainwindow(): Promise<number | undefined> {
    return this.adapter.get<number>("mcpdrainwindow");
  }

  /** Stores the shutdown drain window of the 1.1.84 serve mode as the user configured value with no code ceiling. */
  async setdrainwindow(window: number): Promise<void> {
  ...
  async getproviders(): Promise<providerconfig[]> {
    return (await this.adapter.get<providerconfig[]>("llmproviders")) ?? [];
  }
  ...
  async getlocalmodel(): Promise<localmodelconfig | undefined> {
    return this.adapter.get<localmodelconfig>("llmlocalmodel");
  }

  /** Stores the local model endpoint config after one save or health check. */
  async setlocalmodel(config: localmodelconfig): Promise<void> {
    return this.adapter.set("llmlocalmodel", config);
  }

  /** Returns every model route entry of the routing table, newest update first. */
  async getmodelroutes(): Promise<modelroute[]> {
    return (await this.adapter.get<modelroute[]>("llmmodelroutes")) ?? [];
  }

  /** Replaces the stored routing table after one route edit. */
  async setmodelroutes(routes: modelroute[]): Promise<void> {
  ...
  async addmodelrouterevision(route: modelroute): Promise<void> {
    await this.adapter.set(
      "llmmodelroutehistory",
      [route, ...((await this.adapter.get<modelroute[]>("llmmodelroutehistory")) ?? [])].slice(0, 200),
    );
  }

  /** Returns the model route revision history, newest first. */
  async getmodelroutehistory(): Promise<modelroute[]> {
    return (await this.adapter.get<modelroute[]>("llmmodelroutehistory")) ?? [];
  }
  ...
  async getusagerecords(): Promise<usagerecord[]> {
    return (await this.adapter.get<usagerecord[]>("llmusage")) ?? [];
  }
  ...
  async getusage(
    filter: { runid?: string; stepid?: string; since?: number; until?: number } = {},
  ): Promise<{ prompttokens: number; completiontokens: number; totaltokens: number; cost: number; calls: number }> {
    const records = (await this.getusagerecords()).filter(
      (record) =>
  ...
  async setplandrafts(drafts: plandraft[]): Promise<void> {
    return this.adapter.set("llmplandrafts", drafts);
  }

  /** Returns every stored model drafted plan, newest first. */
  async getplandrafts(): Promise<plandraft[]> {
    return (await this.adapter.get<plandraft[]>("llmplandrafts")) ?? [];
  }
  ...
  async setreplans(replans: replanrecord[]): Promise<void> {
    return this.adapter.set("llmreplans", replans);
  }

  /** Returns every stored replan record, newest first. */
  async getreplans(): Promise<replanrecord[]> {
    return (await this.adapter.get<replanrecord[]>("llmreplans")) ?? [];
  }
  ...
  async addreflectnote(note: reflectnote): Promise<void> {
    await this.adapter.set(
      "llmreflectnotes",
      [note, ...((await this.adapter.get<reflectnote[]>("llmreflectnotes")) ?? [])].slice(0, 100),
    );
  }

  /** Returns the stored reflection notes, newest first. */
  async getreflectnotes(): Promise<reflectnote[]> {
    return (await this.adapter.get<reflectnote[]>("llmreflectnotes")) ?? [];
  }
  ...
  async getprompttemplates(): Promise<prompttemplate[]> {
    return (await this.adapter.get<prompttemplate[]>("llmprompttemplates")) ?? [];
  }
  ...
  async getcostbudget(runid?: string): Promise<costbudget | undefined> {
    ...
    return (
      budgets.find((budget) => runid !== undefined && budget.runid === runid) ??
      budgets.find((budget) => budget.runid === undefined)
    );
  }
  ...
  async getcommandparse(): Promise<commandparse | undefined> {
    return this.adapter.get<commandparse>("llmcommandparse");
  }

  /** Stores the latest parsed natural language command. */
  async setcommandparse(parse: commandparse): Promise<void> {
  ...
  async getguardnotices(): Promise<modeloutput[]> {
    return (await this.adapter.get<modeloutput[]>("llmguardnotices")) ?? [];
  }
  ...
  async getgatewayconfigs(): Promise<baseurlconfig[]> {
    return (await this.adapter.get<baseurlconfig[]>("gatewayconfigs")) ?? [];
  }

  /** Replaces the stored provider gateway configs after one save, consent or removal. */
  async setgatewayconfigs(configs: baseurlconfig[]): Promise<void> {
  ...
  async getgatewaymodelcaches(): Promise<modelcacherecord[]> {
    return (await this.adapter.get<modelcacherecord[]>("gatewaymodelcaches")) ?? [];
  }
  ...
  async setgatewaymodelcache(record: modelcacherecord): Promise<void> {
    await this.adapter.set("gatewaymodelcaches", [
      record,
      ...(await this.getgatewaymodelcaches()).filter((entry) => entry.providerid !== record.providerid),
    ]);
  }
  ...
  async getgatewaychats(): Promise<gatewaychatstate[]> {
    return (await this.adapter.get<gatewaychatstate[]>("gatewaychats")) ?? [];
  }
  ...
  async addgatewaychat(state: gatewaychatstate): Promise<void> {
    await this.adapter.set(
      "gatewaychats",
      [state, ...(await this.getgatewaychats()).filter((entry) => entry.requestid !== state.requestid)].slice(0, 20),
    );
  }
  ...
  async removegatewaychat(requestid: string): Promise<void> {
    await this.adapter.set(
      "gatewaychats",
      (await this.getgatewaychats()).filter((entry) => entry.requestid !== requestid),
    );
  }
  ...
  async getgatewaycachewindow(): Promise<number | undefined> {
    return this.adapter.get<number>("gatewaycachewindow");
  }

  /** Stores the user configured model cache refresh window in milliseconds. */
  async setgatewaycachewindow(window: number): Promise<void> {
  ...
  async getagents(): Promise<agentidentity[]> {
    return (await this.adapter.get<agentidentity[]>("swarmagents")) ?? [];
  }

  /** Replaces the stored agent identities after one register, assign, bind, spawn or lifecycle change. */
  async setagents(agents: agentidentity[]): Promise<void> {
  ...
  async gettaskqueue(): Promise<taskqueue | undefined> {
    return this.adapter.get<taskqueue>("swarmtaskqueue");
  }

  /** Replaces the stored task queue after one enqueue, claim, steal, complete, cancel or requeue. */
  async settaskqueue(queue: taskqueue): Promise<void> {
  ...
  async getmailboxes(): Promise<agentmailbox[]> {
    return (await this.adapter.get<agentmailbox[]>("swarmmailboxes")) ?? [];
  }
    ...
    const trimmed =
      retention === undefined
        ...
        : mailboxes.map((mailbox) => ({
            ...mailbox,
            inbox: mailbox.inbox.slice(0, retention),
            outbox: mailbox.outbox.slice(0, retention),
          }));
  ...
  async getblackboard(): Promise<blackboard | undefined> {
    return this.adapter.get<blackboard>("swarmblackboard");
  }

  /** Replaces the stored blackboard after one post, retire or sweep. */
  async setblackboard(board: blackboard): Promise<void> {
    return this.adapter.set("swarmblackboard", board);
  }

  /** Returns the killswitch state of the swarm. */
  async getkillswitch(): Promise<killswitch | undefined> {
    return this.adapter.get<killswitch>("swarmkillswitch");
  }
  ...
  async getspawnrecords(): Promise<spawnrecord[]> {
    return (await this.adapter.get<spawnrecord[]>("swarmspawns")) ?? [];
  }
  ...
  async getagentusage(): Promise<agentusage[]> {
    return (await this.adapter.get<agentusage[]>("swarmusage")) ?? [];
  }
  ...
  async swarmoverview(): Promise<{
    ...
    return swarmoverviewof({
      agents,
      queue: queue ?? { lanes: [], priorities: [], completionpolicy: "all", items: [], claims: [] },
      mailboxes,
    });
  }
  ...
  async gettopology(): Promise<leaderworker | undefined> {
    return this.adapter.get<leaderworker>("swarmtopology");
  }

  /** Replaces the stored leader worker topology after one election, assignment, collection or scaling change. */
  async settopology(topology: leaderworker): Promise<void> {
  ...
  async getplannersplits(): Promise<plannerexecutor[]> {
    return (await this.adapter.get<plannerexecutor[]>("swarmsplits")) ?? [];
  }

  /** Replaces the stored planner executor splits after one split or one executor step report. */
  async setplannersplits(splits: plannerexecutor[]): Promise<void> {
  ...
  async addcriticreview(review: criticreview): Promise<void> {
    await this.adapter.set("swarmreviews", [
      review,
      ...((await this.adapter.get<criticreview[]>("swarmreviews")) ?? []),
    ]);
  }

  /** Returns the recorded critic reviews, newest first. */
  async getcriticreviews(): Promise<criticreview[]> {
    return (await this.adapter.get<criticreview[]>("swarmreviews")) ?? [];
  }

  /** Records one verifier check of a result claim, newest first. */
  async addverifiercheck(check: verifiercheck): Promise<void> {
    await this.adapter.set("swarmverifierchecks", [
      check,
      ...((await this.adapter.get<verifiercheck[]>("swarmverifierchecks")) ?? []),
    ]);
  }

  /** Returns the recorded verifier checks with their pass and fail outcomes, newest first. */
  async getverifierchecks(): Promise<verifiercheck[]> {
    return (await this.adapter.get<verifiercheck[]>("swarmverifierchecks")) ?? [];
  }

  /** Replaces the stored review requests routed between agents after one request, ack, answer or timeout. */
  async setreviewrequests(requests: reviewrequest[]): Promise<void> {
  ...
  async getreviewrequests(): Promise<reviewrequest[]> {
    return (await this.adapter.get<reviewrequest[]>("swarmreviewrequests")) ?? [];
  }
  ...
  async addhandoff(record: handoffrecord): Promise<void> {
    await this.adapter.set(
      "swarmhandoffs",
      [record, ...((await this.adapter.get<handoffrecord[]>("swarmhandoffs")) ?? [])].filter(
  ...
  async updatehandoff(record: handoffrecord): Promise<void> {
    await this.adapter.set(
      "swarmhandoffs",
      ((await this.adapter.get<handoffrecord[]>("swarmhandoffs")) ?? []).map((entry) =>
  ...
  async gethandoffs(): Promise<handoffrecord[]> {
    return (await this.adapter.get<handoffrecord[]>("swarmhandoffs")) ?? [];
  }

  /** Replaces the stored resource locks after one acquire, release or expiry sweep. */
  async setlocks(locks: resourcelock[]): Promise<void> {
  ...
  async getlocks(): Promise<resourcelock[]> {
    return (await this.adapter.get<resourcelock[]>("swarmlocks")) ?? [];
  }

  /** Records one conflict scan report of overlapping writes, newest first. */
  async addconflictscan(scan: conflictscan): Promise<void> {
    await this.adapter.set("swarmconflicts", [
      scan,
      ...((await this.adapter.get<conflictscan[]>("swarmconflicts")) ?? []),
    ]);
  }

  /** Returns the recorded conflict scan reports, newest first. */
  async getconflictscans(): Promise<conflictscan[]> {
    return (await this.adapter.get<conflictscan[]>("swarmconflicts")) ?? [];
  }

  /** Stores the merged result report with its mergeentry provenance. */
  async setreport(report: resultreport): Promise<void> {
    return this.adapter.set("swarmreport", report);
  }

  /** Returns the stored merged result report across agents. */
  async getreport(): Promise<resultreport | undefined> {
    return this.adapter.get<resultreport>("swarmreport");
  }
  ...
  async addboardsnapshot(board: progressboard): Promise<void> {
    ...
    await this.adapter.set(
      "swarmboards",
      [board, ...((await this.adapter.get<progressboard[]>("swarmboards")) ?? [])].slice(0, retention ?? 100),
    );
  }

  /** Returns the stored progressboard snapshots, newest first. */
  async getboardsnapshots(): Promise<progressboard[]> {
    return (await this.adapter.get<progressboard[]>("swarmboards")) ?? [];
  }

  /** Records one escalation lifted to the user, newest first. */
  async addescalation(escalation: escalationrecord): Promise<void> {
    await this.adapter.set("swarmescalations", [
      escalation,
      ...((await this.adapter.get<escalationrecord[]>("swarmescalations")) ?? []),
    ]);
  }
  ...
  async updateescalation(escalation: escalationrecord): Promise<void> {
    await this.adapter.set(
      "swarmescalations",
      ((await this.adapter.get<escalationrecord[]>("swarmescalations")) ?? []).map((entry) =>
        entry.id === escalation.id ? escalation : entry,
      ),
    );
  }
  ...
  async getescalations(): Promise<escalationrecord[]> {
    return (await this.adapter.get<escalationrecord[]>("swarmescalations")) ?? [];
  }
  ...
  async setconsensusround(round: consensusround): Promise<void> {
    ...
    await this.adapter.set(
      "swarmconsensus",
      rounds.some((entry) => entry.id === round.id)
        ? rounds.map((entry) => (entry.id === round.id ? round : entry))
        : [round, ...rounds],
    );
  }

  /** Returns the consensus rounds with their votes and quorum states, newest first. */
  async getconsensusrounds(): Promise<consensusround[]> {
    return (await this.adapter.get<consensusround[]>("swarmconsensus")) ?? [];
  }
  ...
  async addswarmaction(action: swarmaction): Promise<void> {
    await this.adapter.set(
      "swarmtimeline",
      [...((await this.adapter.get<swarmaction[]>("swarmtimeline")) ?? []), action].slice(-500),
    );
  }
  ...
  async addswarmcost(cost: swarmcost): Promise<void> {
    await this.adapter.set(
      "swarmcosts",
      [cost, ...((await this.adapter.get<swarmcost[]>("swarmcosts")) ?? [])].slice(0, 100),
    );
  }

  /** Returns the stored shared cost accounting snapshots of the swarm, newest first. */
  async getswarmcosts(): Promise<swarmcost[]> {
    return (await this.adapter.get<swarmcost[]>("swarmcosts")) ?? [];
  }
  ...
  async getenvironmentgrants(): Promise<environmentkind[] | undefined> {
  ...
  async removerunstate(profileid: string): Promise<void> {
    ...
    await this.adapter.set(
      "runstateindex",
      index.filter((entry) => entry !== profileid),
    );
    await this.adapter.set(`runstate:${profileid}`, {
      payload: "",
      algorithm: "sha-256",
      digest: "",
      sealedat: 0,
  ...
  async addworkerevent(event: workerevent): Promise<void> {
    await this.adapter.set(
      "workerevents",
      [event, ...((await this.adapter.get<workerevent[]>("workerevents")) ?? [])].slice(0, 500),
    );
  }

  /** Returns the recorded worker spawn and teardown events, newest first. */
  async getworkerevents(): Promise<workerevent[]> {
    return (await this.adapter.get<workerevent[]>("workerevents")) ?? [];
  }
  ...
  async addoffscreenentry(entry: offscreenregistryentry): Promise<void> {
    await this.adapter.set("offscreenregistry", [
      entry,
      ...((await this.adapter.get<offscreenregistryentry[]>("offscreenregistry")) ?? []),
    ]);
  }
  ...
  async updateoffscreenentry(entry: offscreenregistryentry): Promise<void> {
    await this.adapter.set(
      "offscreenregistry",
      ((await this.adapter.get<offscreenregistryentry[]>("offscreenregistry")) ?? []).map((candidate) =>
        candidate.runid === entry.runid ? entry : candidate,
      ),
    );
  }

  /** Returns the offscreen document registry with the reasons and justification of every spawn. */
  async getoffscreenentries(): Promise<offscreenregistryentry[]> {
    return (await this.adapter.get<offscreenregistryentry[]>("offscreenregistry")) ?? [];
  }
  ...
  async addsandboxrender(render: sandboxrender): Promise<void> {
    await this.adapter.set(
      "sandboxrenders",
      [render, ...((await this.adapter.get<sandboxrender[]>("sandboxrenders")) ?? [])].slice(0, 500),
    );
  }

  /** Returns the recorded sandbox renders with their provenance, newest first. */
  async getsandboxrenders(): Promise<sandboxrender[]> {
    return (await this.adapter.get<sandboxrender[]>("sandboxrenders")) ?? [];
  }

  /** Replaces the stored run locks after one acquisition, release or expiry sweep. */
  async setrunlocks(locks: runlock[]): Promise<void> {
    return this.adapter.set("runlocks", locks);
  }

  /** Returns the held run locks with their sessions, runs and expiries. */
  async getrunlocks(): Promise<runlock[]> {
    return (await this.adapter.get<runlock[]>("runlocks")) ?? [];
  }
  ...
  async trackrunstatequota(used: number): Promise<void> {
    ...
    await this.adapter.set("runstatequota", {
      used,
      ...(settings?.runstatebytes !== undefined ? { ceiling: settings.runstatebytes } : {}),
      trackedat: Date.now(),
    });
  }

  /** Returns the last tracked storage quota usage of the run state with its ceiling when the user configured one. */
  async getrunstatequota(): Promise<{ used: number; ceiling?: number; trackedat: number } | undefined> {
    return this.adapter.get<{ used: number; ceiling?: number; trackedat: number }>("runstatequota");
  }

  /** Exports every stored run state as one single audit record through the runstate export envelope. */
  async exportrunstates(): Promise<{
    runs: number;
    urls: number;
    environments: number;
    offloaded: number;
  ...
  async setautomationallowlist(entries: automationallowlistentry[]): Promise<void> {
  ...
  async getautomationallowlist(): Promise<automationallowlistentry[]> {
    return (await this.adapter.get<automationallowlistentry[]>("automationallowlist")) ?? [];
  }
  ...
  async addallowlistorigin(entry: automationallowlistentry): Promise<void> {
    ...
    if (entries.some((candidate) => candidate.origin === entry.origin && candidate.profileid === entry.profileid))
      return;
  ...
  async removeallowlistorigin(origin: string, profileid: string): Promise<void> {
    await this.setautomationallowlist(
      (await this.getautomationallowlist()).filter(
        (entry) => !(entry.origin === origin && entry.profileid === profileid),
      ),
    );
  }

  /** Replaces the per site origin profiles with their kind grants and denials; one profile per origin. */
  async setoriginprofiles(profiles: originprofile[]): Promise<void> {
    return this.adapter.set("originprofiles", profiles);
  }

  /** Returns the stored per site origin profiles, oldest update first. */
  async getoriginprofiles(): Promise<originprofile[]> {
    return (await this.adapter.get<originprofile[]>("originprofiles")) ?? [];
  }
  ...
  async saveoriginprofile(profile: originprofile): Promise<void> {
    ...
    await this.setoriginprofiles(
      profiles.some((candidate) => candidate.origin === profile.origin)
        ? profiles.map((candidate) => (candidate.origin === profile.origin ? profile : candidate))
        : [...profiles, profile],
    );
  }

  /** Replaces the consent windows; active windows keep their expiry timestamps and closed windows stay for the audit trail. */
  async setconsentwindows(windows: consentwindow[]): Promise<void> {
    return this.adapter.set("consentwindows", windows);
  }

  /** Returns the stored consent windows, newest start first. */
  async getconsentwindows(): Promise<consentwindow[]> {
    return (await this.adapter.get<consentwindow[]>("consentwindows")) ?? [];
  }
  ...
  async addrevocation(event: revokerunevent): Promise<void> {
    await this.adapter.set(
      "revocations",
      [event, ...((await this.adapter.get<revokerunevent[]>("revocations")) ?? [])].slice(0, 500),
    );
  }

  /** Returns the recorded mid run revocations with their halted step ids, newest first. */
  async getrevocations(): Promise<revokerunevent[]> {
    return (await this.adapter.get<revokerunevent[]>("revocations")) ?? [];
  }

  /** Replaces the fresh class consents per origin. */
  async setclassconsents(consents: classconsent[]): Promise<void> {
    return this.adapter.set("classconsents", consents);
  }

  /** Returns the fresh class consents per origin, newest grant first. */
  async getclassconsents(): Promise<classconsent[]> {
    return (await this.adapter.get<classconsent[]>("classconsents")) ?? [];
  }
  ...
  async addclassconsent(consent: classconsent): Promise<void> {
    const consents = (await this.getclassconsents()).filter(
      (candidate) => !(candidate.origin === consent.origin && candidate.sensitiveclass === consent.sensitiveclass),
    );
    await this.setclassconsents([consent, ...consents]);
  }

  /** Replaces the mask rules for sensitive field shapes per origin. */
  async setmaskrules(rules: maskrule[]): Promise<void> {
  ...
  async getmaskrules(): Promise<maskrule[]> {
    return (await this.adapter.get<maskrule[]>("maskrules")) ?? [];
  }

  /** Adds one mask rule for field shapes, optionally scoped to one origin. */
  async addmaskrule(rule: maskrule): Promise<void> {
    await this.setmaskrules([...(await this.getmaskrules()), rule]);
  }

  /** Removes one mask rule by its id. */
  async removemaskrule(id: string): Promise<void> {
  ...
  async setimmutablelog(log: storedrunlog): Promise<void> {
    return this.adapter.set(`immutablelog:${log.runid}`, log);
  }

  /** Returns the stored run log of one run; an absent log returns undefined. */
  async getimmutablelog(runid: string): Promise<storedrunlog | undefined> {
    return this.adapter.get<storedrunlog>(`immutablelog:${runid}`);
  }
  ...
  async expireimmutablelogs(retention: number | undefined, now: number): Promise<storedrunlog[]> {
    ...
    for (const log of logs) {
      if (log.seal !== undefined && now - log.seal.sealedat > retention) {
        const summary: storedrunlog = {
          runid: log.runid,
          sessionid: log.sessionid,
          entries: [],
          seal: { ...log.seal, entries: log.seal.entries },
          updatedat: now,
        };
  ...
  async setsecretvault(entries: secretvaultentry[]): Promise<void> {
  ...
  async getsecretvault(): Promise<secretvaultentry[]> {
    return (await this.adapter.get<secretvaultentry[]>("secretvault")) ?? [];
  }
  ...
  async removesecret(vaultid: string): Promise<void> {
  ...
  async stampsecretuse(vaultid: string, at: number): Promise<void> {
    await this.setsecretvault(
      (await this.getsecretvault()).map((entry) => (entry.vaultid === vaultid ? { ...entry, lastusedat: at } : entry)),
    );
  }

  /** Replaces the connectallow entries of external senders; the list ships empty by default with user managed entries only. */
  async setconnectallow(entries: connectallowentry[]): Promise<void> {
    return this.adapter.set("connectallow", entries);
  }

  /** Returns the stored connectallow entries, oldest add first. */
  async getconnectallow(): Promise<connectallowentry[]> {
    return (await this.adapter.get<connectallowentry[]>("connectallow")) ?? [];
  }
  ...
  async removeconnectallow(senderid: string): Promise<void> {
  ...
  async setratelimitbuckets(buckets: ratelimitbucket[]): Promise<void> {
  ...
  async getratelimitbuckets(): Promise<ratelimitbucket[]> {
    return (await this.adapter.get<ratelimitbucket[]>("ratelimitbuckets")) ?? [];
  }
  ...
  async saveratelimitbucket(bucket: ratelimitbucket): Promise<void> {
    ...
    await this.setratelimitbuckets(
      buckets.some((candidate) => candidate.origin === bucket.origin && candidate.sessionid === bucket.sessionid)
        ? buckets.map((candidate) =>
            candidate.origin === bucket.origin && candidate.sessionid === bucket.sessionid ? bucket : candidate,
          )
        : [...buckets, bucket],
    );
  }
  ...
  async removeratelimitbucket(origin: string, sessionid: string): Promise<void> {
    await this.setratelimitbuckets(
      (await this.getratelimitbuckets()).filter(
        (bucket) => !(bucket.origin === origin && bucket.sessionid === sessionid),
      ),
    );
  }

  /** Replaces the confirm gates with their payloads and states; a resolved or refused gate stays terminal for the audit trail. */
  async setgates(gates: confirmgate[]): Promise<void> {
    return this.adapter.set("confirmgates", gates);
  }

  /** Returns the stored confirm gates, newest open first. */
  async getgates(): Promise<confirmgate[]> {
    return (await this.adapter.get<confirmgate[]>("confirmgates")) ?? [];
  }
  ...
  async savegate(gate: confirmgate): Promise<void> {
    ...
    await this.setgates(
      gates.some((candidate) => candidate.stepid === gate.stepid && candidate.kind === gate.kind)
        ? gates.map((candidate) =>
            candidate.stepid === gate.stepid && candidate.kind === gate.kind ? gate : candidate,
          )
        : [gate, ...gates],
    );
  }
  ...
  async addgateresolution(resolution: gateresolution): Promise<void> {
    await this.adapter.set(
      "gateresolutions",
      [resolution, ...((await this.adapter.get<gateresolution[]>("gateresolutions")) ?? [])].slice(0, 500),
    );
  }

  /** Returns the recorded gate resolution events with their human action provenance, newest first. */
  async getgateresolutions(): Promise<gateresolution[]> {
    return (await this.adapter.get<gateresolution[]>("gateresolutions")) ?? [];
  }

  /** Replaces the redactshot regions per origin and page template. */
  async setredactregions(regions: redactregion[]): Promise<void> {
  ...
  async getredactregions(): Promise<redactregion[]> {
    return (await this.adapter.get<redactregion[]>("redactregions")) ?? [];
  }

  /** Adds one redactshot region, derived from a field shape or drawn by the user. */
  async addredactregion(region: redactregion): Promise<void> {
    await this.setredactregions([...(await this.getredactregions()), region]);
  }

  /** Removes one redactshot region by its id. */
  async removeredactregion(id: string): Promise<void> {
  ...
  async addphishverdict(verdict: phishverdict): Promise<void> {
    await this.adapter.set(
      ...
      [
        verdict,
        ...((await this.adapter.get<phishverdict[]>("phishverdicts")) ?? []).filter(
          (candidate) => candidate.origin !== verdict.origin,
        ),
      ].slice(0, 500),
    );
  }
  ...
  async getphishverdicts(): Promise<phishverdict[]> {
    return (await this.adapter.get<phishverdict[]>("phishverdicts")) ?? [];
  }
  ...
  async addpermdiff(diff: permdiffrecord): Promise<void> {
    await this.adapter.set(
      "permdiffs",
      [diff, ...((await this.adapter.get<permdiffrecord[]>("permdiffs")) ?? [])].slice(0, 500),
    );
  }

  /** Returns the recorded permdiffs of each installed update, newest first. */
  async getpermdiffs(): Promise<permdiffrecord[]> {
    return (await this.adapter.get<permdiffrecord[]>("permdiffs")) ?? [];
  }

  /** Stores the last installed permission set the permdiff of the next update compares against. */
  async setlastpermissions(permissions: string[], version: string): Promise<void> {
  ...
  async getlastpermissions(): Promise<{ permissions: string[]; version: string } | undefined> {
    return this.adapter.get<{ permissions: string[]; version: string }>("lastpermissions");
  }
  ...
  async getsafedefaultapplications(): Promise<safedefaultapplication[]> {
    return (await this.adapter.get<safedefaultapplication[]>("safedefaults")) ?? [];
  }
  ...
  async adddeferredevent(event: deferredevent): Promise<void> {
    await this.adapter.set(
      "deferredevents",
      [event, ...((await this.adapter.get<deferredevent[]>("deferredevents")) ?? [])].slice(0, 500),
    );
  }

  /** Returns the recorded deferred command events, newest first. */
  async getdeferredevents(): Promise<deferredevent[]> {
    return (await this.adapter.get<deferredevent[]>("deferredevents")) ?? [];
  }
  ...
  async gettransparencyview(): Promise<{
  ...
  async writesitenote(note: sitenote): Promise<void> {
    ...
    await this.setsitenotes(
      notes.some((candidate) => candidate.id === note.id)
  ...
  async removesitenote(id: string): Promise<void> {
  ...
  async setscratchpad(entries: scratchpadentry[]): Promise<void> {
    return this.adapter.set("scratchpad", entries);
  }

  /** Returns every stored scratchpad entry, newest first. */
  async getscratchpadall(): Promise<scratchpadentry[]> {
    return (await this.adapter.get<scratchpadentry[]>("scratchpad")) ?? [];
  }

  /** Appends one scratchpad entry: the pad stays append only so no later write rewrites an earlier entry. */
  async appendscratchentry(entry: scratchpadentry): Promise<void> {
  ...
  async readscratchpad(taskid: string, sessionid: string): Promise<scratchpadentry[]> {
  ...
  async setrunsummary(summary: runsummary): Promise<void> {
  ...
  async getrunsummary(runid: string): Promise<runsummary | undefined> {
    return this.adapter.get<runsummary>(`runsummary:${runid}`);
  }
  ...
  async expirerunsummaries(retention: number | undefined, now: number): Promise<runsummary[]> {
    ...
    for (const summary of summaries) {
      if (now - summary.distilledat > retention)
        await this.adapter.set(`runsummary:${summary.runid}`, {
          ...summary,
          steps: [],
          kinds: [],
  ...
  async setrecallindex(index: recallindexentry[]): Promise<void> {
    return this.adapter.set("recallindex", index);
  }

  /** Returns the stored semantic recall index entries, newest first. */
  async getrecallindex(): Promise<recallindexentry[]> {
    return (await this.adapter.get<recallindexentry[]>("recallindex")) ?? [];
  }
  ...
  async addrecallentry(entry: recallindexentry): Promise<void> {
    ...
    if (index.some((candidate) => candidate.fingerprint === entry.fingerprint && candidate.origin === entry.origin))
      return;
  ...
  async semanticrecall(
    ...
    rank: (index: recallindexentry[], query: recallquery, scope: { origins: string[] }) => recallmatch[],
  ): Promise<recallmatch[]> {
  ...
  async setcorrections(corrections: correctionentry[]): Promise<void> {
  ...
  async addcorrection(entry: correctionentry): Promise<void> {
    await this.setcorrections([entry, ...((await this.adapter.get<correctionentry[]>("corrections")) ?? [])]);
  }
  ...
  async setconsentmemory(entries: consentmemoryentry[]): Promise<void> {
  ...
  async addconsentmemoryentry(entry: consentmemoryentry): Promise<void> {
    await this.setconsentmemory([entry, ...((await this.adapter.get<consentmemoryentry[]>("consentmemory")) ?? [])]);
  }

  /** Replaces the stored error surface payloads of failed steps. */
  async seterrorsurfaces(surfaces: errorsurface[]): Promise<void> {
  ...
  async adderrorsurface(surface: errorsurface): Promise<void> {
    await this.seterrorsurfaces(
      [surface, ...((await this.adapter.get<errorsurface[]>("errorsurfaces")) ?? [])].slice(0, 500),
    );
  }

  /** Replaces the incremental history search corpus of session metadata, notes and run summaries. */
  async sethistoryindex(corpus: historyindexentry[]): Promise<void> {
    return this.adapter.set("historyindex", corpus);
  }

  /** Returns the incremental history search corpus, newest entry first. */
  async gethistoryindex(): Promise<historyindexentry[]> {
    return (await this.adapter.get<historyindexentry[]>("historyindex")) ?? [];
  }
  ...
  async addhistoryentry(entry: historyindexentry): Promise<void> {
    ...
    await this.sethistoryindex([
      entry,
      ...corpus.filter((candidate) => !(candidate.source === entry.source && candidate.id === entry.id)),
    ]);
  }
  ...
  async historysearch(
    ...
    search: (corpus: historyindexentry[], query: historysearchquery) => historysearchhit[],
  ...
  async settabsession(ref: tabsessionref): Promise<void> {
  ...
  async gettabsession(tabid: number): Promise<tabsessionref | undefined> {
    return this.adapter.get<tabsessionref>(`tabsession:${tabid}`);
  }
  ...
  async exportsessionbundle(
    ...
    return {
      kind: "sessionbundle",
      notes: await this.getsitenotes(),
      summaries: await this.listrunsummaries(),
      corrections: await this.getcorrections(),
      exportedat,
    };
  }
  ...
  async getpaletteusage(): Promise<paletteuserecord[]> {
    return (await this.adapter.get<paletteuserecord[]>("paletteusage")) ?? [];
  }
  ...
  async setpaletteusage(records: paletteuserecord[]): Promise<void> {
    return this.adapter.set("paletteusage", records);
  }

  /** Returns the stored taskinput history, newest first. */
  async gettaskinputs(): Promise<taskinputsubmission[]> {
    return (await this.adapter.get<taskinputsubmission[]>("taskinputs")) ?? [];
  }
  ...
  async addtaskinput(entry: taskinputsubmission): Promise<void> {
    ...
    await this.adapter.set(
      "taskinputs",
      retention === undefined ? history : history.filter((candidate) => entry.at - candidate.at < retention),
    );
  }

  /** Returns the onboarding completion state; an absent state means the walkthrough never ran. */
  async getonboardingstate(): Promise<onboardingstate | undefined> {
    return this.adapter.get<onboardingstate>("onboarding");
  }
  ...
  async getv1sunset(): Promise<v1sunsetstate | undefined> {
    return this.adapter.get<v1sunsetstate>("v1sunset");
  }
  ...
  async setv1sunset(state: v1sunsetstate): Promise<void> {
  ...
  async getmigrationprompt(): Promise<migrationpromptstate | undefined> {
    return this.adapter.get<migrationpromptstate>("migrationprompt");
  }
  ...
  async setmigrationprompt(state: migrationpromptstate): Promise<void> {
  ...
  async getsurfacelayout(surface: surfacelayout["surface"]): Promise<surfacelayout | undefined> {
    return this.adapter.get<surfacelayout>(`surfacelayout:${surface}`);
  }

  /** Stores the layout preferences of one surface, scoped per profile workspace. */
  async setsurfacelayout(layout: surfacelayout): Promise<void> {
  ...
  async getlogstreamfilters(): Promise<logstreamfilter | undefined> {
    return this.adapter.get<logstreamfilter>("logstreamfilters");
  }

  /** Stores the logstream filter preferences of the live view. */
  async setlogstreamfilters(filter: logstreamfilter): Promise<void> {
  ...
  async getstepapproveresolutions(): Promise<stepapproveresolution[]> {
    return (await this.adapter.get<stepapproveresolution[]>("stepapproveresolutions")) ?? [];
  }

  /** Records one stepapprove resolution in the per origin history. */
  async addstepapproveresolution(resolution: stepapproveresolution): Promise<void> {
  ...
  async getsiteprofile(origin: string): Promise<siteprofile | undefined> {
    return this.adapter.get<siteprofile>(`siteprofile:${origin}`);
  }
  ...
  async setsiteprofiles(profiles: siteprofile[]): Promise<void> {
  ...
  async getshortcutbindings(): Promise<shortcutbinding[]> {
    return (await this.adapter.get<shortcutbinding[]>("shortcutbindings")) ?? [];
  }

  /** Stores the shortcutkeys bindings the user edited in the optionspage. */
  async setshortcutbindings(bindings: shortcutbinding[]): Promise<void> {
  ...
  async getthemepreference(): Promise<"dark" | "light" | "system" | undefined> {
    return this.adapter.get<"dark" | "light" | "system">("themepreference");
  }
  ...
  async getrecenttray(): Promise<recenttrayentry[]> {
    return (await this.adapter.get<recenttrayentry[]>("recenttray")) ?? [];
  }
  ...
  async addrecenttrayentry(entry: recenttrayentry): Promise<void> {
    ...
    await this.adapter.set(
      "recenttray",
      depth !== undefined && Number.isInteger(depth) && depth > 0 ? appended.slice(0, depth) : appended,
    );
  }
  ...
  async getnotificationprefs(): Promise<{ consent: boolean; enabled: boolean } | undefined> {
    return this.adapter.get<{ consent: boolean; enabled: boolean }>("notificationprefs");
  }

  /** Stores the notification consent and preference of the profile; the content consent gates every page content bearing body. */
  async setnotificationprefs(prefs: { consent: boolean; enabled: boolean }): Promise<void> {
  ...
  async getnotificationhistory(): Promise<notificationpayload[]> {
    return (await this.adapter.get<notificationpayload[]>("notificationhistory")) ?? [];
  }
  ...
  async addnotificationhistory(payload: notificationpayload): Promise<void> {
  ...
  async getflowlibrary(): Promise<flowlibraryentry[]> {
    return (await this.adapter.get<flowlibraryentry[]>("flowlibrary")) ?? [];
  }

  /** Replaces the flowlibrary entries of the profile workspace. */
  async setflowlibrary(entries: flowlibraryentry[]): Promise<void> {
  ...
  async getlibraryevents(): Promise<libraryevent[]> {
    return (await this.adapter.get<libraryevent[]>("libraryevents")) ?? [];
  }

  /** Records one library lifecycle event beside the flowlibrary store. */
  async addlibraryevent(event: libraryevent): Promise<void> {
  ...
  async exportlibrarymanifests(): Promise<
    Array<{
      id: string;
      title: string;
      publisher: string;
  ...
  > {
    return (await this.getflowlibrary()).map((entry) => ({
      id: entry.id,
  ...
  async getsyncbridgehooks(): Promise<syncbridgehook[]> {
    return (await this.adapter.get<syncbridgehook[]>("syncbridgehooks")) ?? [];
  }

  /** Replaces the syncbridge hooks of the profile workspace. */
  async setsyncbridgehooks(hooks: syncbridgehook[]): Promise<void> {
  ...
  async getsyncbridgeconflicts(): Promise<syncbridgeconflict[]> {
    return (await this.adapter.get<syncbridgeconflict[]>("syncbridgeconflicts")) ?? [];
  }

  /** Records one syncbridge conflict with both manifest versions. */
  async addsyncbridgeconflict(conflict: syncbridgeconflict): Promise<void> {
  ...
  async resolvesyncbridgeconflict(
    id: string,
    resolution: "local" | "remote" | "merge",
    now: number,
  ): Promise<syncbridgeconflict[]> {
    const conflicts = await this.getsyncbridgeconflicts();
    await this.adapter.set(
      "syncbridgeconflicts",
      conflicts.map((conflict) =>
        conflict.id === id && conflict.resolution === undefined
  ...
  async getattentionentries(): Promise<attentionentry[]> {
    return (await this.adapter.get<attentionentry[]>("attentionfeed")) ?? [];
  }
  ...
  async getreplaycursors(): Promise<Record<string, { cursor: number; playing: boolean }>> {
    return (await this.adapter.get<Record<string, { cursor: number; playing: boolean }>>("replaycursors")) ?? {};
  }

  /** Stores one runreplay cursor for its viewed run. */
  async setreplaycursor(runid: string, cursor: { cursor: number; playing: boolean }): Promise<void> {
  ...
  async getcomparesessions(): Promise<outputcomparesession[]> {
    return (await this.adapter.get<outputcomparesession[]>("comparesessions")) ?? [];
  }

  /** Records one outputcompare session with the metric set it used. */
  async addcomparesession(session: outputcomparesession): Promise<void> {
  ...
  async getbackgroundqueue(): Promise<backgroundqueueentry[]> {
    return (await this.adapter.get<backgroundqueueentry[]>("backgroundqueue")) ?? [];
  }

  /** Replaces the background run queue state after every transition so the restart recovery reads it in one call. */
  async setbackgroundqueue(queue: backgroundqueueentry[]): Promise<void> {
  ...
  async getselcachestate(runid: string): Promise<selcachestate | undefined> {
    return (await this.adapter.get<selcachestate>(`selcache:${runid}`)) ?? undefined;
  }
  ...
  async setselcachestate(state: selcachestate): Promise<void> {
  ...
  async pruneselcache(runid: string): Promise<void> {
  ...
  async getsnapshotbases(): Promise<Array<{ id: string; runid: string; ref: string; at: number }>> {
    return (
      (await this.adapter.get<Array<{ id: string; runid: string; ref: string; at: number }>>("snapshotbases")) ?? []
    );
  }

  /** Stores one incrsnapshot base ref record for its run so every later delta of the run references it. */
  async addsnapshotbase(base: { id: string; runid: string; ref: string; at: number }): Promise<void> {
    await this.adapter.set("snapshotbases", [
      ...(await this.getsnapshotbases()).filter((candidate) => candidate.runid !== base.runid),
      base,
    ]);
  }

  /** Prunes the incrsnapshot base refs of one run at run end; the deltas of the run end with it. */
  async prunesnapshotbases(runid: string): Promise<void> {
    await this.adapter.set(
      "snapshotbases",
      (await this.getsnapshotbases()).filter((candidate) => candidate.runid !== runid),
    );
  }

  /** Stores one computed incrsnapshot delta of a run beside its base so the executor skips recomputation on an empty delta. */
  async addsnapshotdelta(delta: incrsnapshotdelta): Promise<void> {
  ...
  async getsnapshotdelta(runid: string, baseref: string): Promise<incrsnapshotdelta | undefined> {
    return (await this.adapter.get<incrsnapshotdelta>(`snapshotdelta:${runid}:${baseref}`)) ?? undefined;
  }

  /** Returns the chunkextract cursors per table so an interrupted big table extraction resumes from its cursor. */
  async getchunkcursors(): Promise<Record<string, chunkextractcursor>> {
    return (await this.adapter.get<Record<string, chunkextractcursor>>("chunkcursors")) ?? {};
  }

  /** Stores one chunkextract cursor for its table so the next window resumes where the last window stopped. */
  async setchunkcursor(tableid: string, cursor: chunkextractcursor): Promise<void> {
  ...
  async clearchunkcursor(tableid: string): Promise<void> {
  ...
  async getperfrecords(): Promise<perfrecord[]> {
    return (await this.adapter.get<perfrecord[]>("perfrecords")) ?? [];
  }
  ...
  async addperfrecord(record: perfrecord): Promise<void> {
  ...
  async getlazyloadrecords(): Promise<lazyloadrecord[]> {
    return (await this.adapter.get<lazyloadrecord[]>("lazyloadrecords")) ?? [];
  }

  /** Records one lazymods load telemetry record: which module loaded, why, and how long the resolution took. */
  async addlazyloadrecord(record: lazyloadrecord): Promise<void> {
  ...
  async getqueuedepths(): Promise<queuedepthsample[]> {
    return (await this.adapter.get<queuedepthsample[]>("queuedepths")) ?? [];
  }

  /** Records one worker queue depth sample: the pending parse tasks and the deferred tasks the backpressure held at one moment. */
  async recordqueuedepth(sample: queuedepthsample): Promise<void> {
  ...
  async getheightmaps(): Promise<Array<{ surface: string; heights: Record<string, number>; at: number }>> {
    return (
      (await this.adapter.get<Array<{ surface: string; heights: Record<string, number>; at: number }>>("heightmaps")) ??
      []
    );
  }

  /** Stores one virtlist height map for its surface; the measured row heights stay for the next open of the surface. */
  async setheightmap(record: { surface: string; heights: Record<string, number>; at: number }): Promise<void> {
    await this.adapter.set("heightmaps", [
      ...(await this.getheightmaps()).filter((candidate) => candidate.surface !== record.surface),
      record,
    ]);
  }
  ...
  async getdomainlanes(runid: string): Promise<domainlane[]> {
    return (await this.adapter.get<domainlane[]>(`domainlanes:${runid}`)) ?? [];
  }

  /** Stores the domain lanes of one batch run; every lane runs at most its user chosen slots while its overflow queues. */
  async setdomainlanes(runid: string, lanes: domainlane[]): Promise<void> {
    await this.adapter.set(`domainlanes:${runid}`, lanes);
  }

  /** Returns the runbudget records of the profile workspace, newest first. */
  async getrunbudgets(): Promise<runbudgetrecord[]> {
    return (await this.adapter.get<runbudgetrecord[]>("runbudgets")) ?? [];
  }
  ...
  async addrunbudget(record: runbudgetrecord): Promise<void> {
    await this.adapter.set("runbudgets", [
      record,
      ...(await this.getrunbudgets()).filter((candidate) => candidate.runid !== record.runid),
    ]);
  }
  ...
  async getbudgetalerts(): Promise<budgetalert[]> {
    return (await this.adapter.get<budgetalert[]>("budgetalerts")) ?? [];
  }

  /** Records one budgetalert of a run; the critical alert pauses the run pending a user choice. */
  async addbudgetalert(alert: budgetalert): Promise<void> {
  ...
  async gettimeoutevents(): Promise<timeoutcancelevent[]> {
    return (await this.adapter.get<timeoutcancelevent[]>("timeoutevents")) ?? [];
  }

  /** Records one timeoutcancel event: the aborted step, its user bound and its logged cancel entry beside the step outcome. */
  async addtimeoutevent(event: timeoutcancelevent): Promise<void> {
  ...
  async getsuspendstates(): Promise<tabsuspendstate[]> {
    return (await this.adapter.get<tabsuspendstate[]>("suspendstates")) ?? [];
  }

  /** Stores one tabsuspend state of a run; the run state stays preserved across the suspend and restore. */
  async setsuspendstate(state: tabsuspendstate): Promise<void> {
    await this.adapter.set("suspendstates", [
      ...(await this.getsuspendstates()).filter((candidate) => candidate.runid !== state.runid),
      state,
    ]);
  }

  /** Clears one tabsuspend state once its tab restored before the step that needed it. */
  async clearsuspendstate(runid: string): Promise<void> {
    await this.adapter.set(
      "suspendstates",
      (await this.getsuspendstates()).filter((candidate) => candidate.runid !== runid),
    );
  }

  /** Returns the runcache entries of every run keyed by their resource digests. */
  async getruncache(): Promise<runcacheentry[]> {
    return (await this.adapter.get<runcacheentry[]>("runcache")) ?? [];
  }

  /** Stores one runcache entry of a run keyed by its digest; a repeat fetch of the same run serves from the entry. */
  async addruncacheentry(entry: runcacheentry): Promise<void> {
    await this.adapter.set("runcache", [
      ...(await this.getruncache()).filter(
        (candidate) => candidate.runid !== entry.runid || candidate.resource !== entry.resource,
      ),
      entry,
    ]);
  }
  ...
  async getresumepoints(runid: string): Promise<resumepoint[]> {
    return (await this.adapter.get<resumepoint[]>(`resumepoints:${runid}`)) ?? [];
  }

  /** Stores one efficientresume checkpoint of a run at a step boundary with its cursor and page digest. */
  async addresumepoint(point: resumepoint): Promise<void> {
    await this.adapter.set(`resumepoints:${point.runid}`, [
      ...(await this.getresumepoints(point.runid)).filter((candidate) => candidate.stepid !== point.stepid),
      point,
    ]);
  }

  /** Clears the efficientresume checkpoints of one run at run end. */
  async cleareresumepoints(runid: string): Promise<void> {
    await this.adapter.set(`resumepoints:${runid}`, []);
  }

  /** Returns the selectorprofile stats of the profile workspace per selector. */
  async getselectorprofiles(): Promise<selectorstats[]> {
    return (await this.adapter.get<selectorstats[]>("selectorprofiles")) ?? [];
  }

  /** Stores one selectorprofile stat; the flagged selectors report above the user latency threshold and never refuse. */
  async setselectorprofile(stats: selectorstats): Promise<void> {
    await this.adapter.set("selectorprofiles", [
      ...(await this.getselectorprofiles()).filter((candidate) => candidate.selector !== stats.selector),
      stats,
    ]);
  }

  /** Returns the steptrace spans of one run for the timeline view and the trace file export. */
  async getsteptrace(runid: string): Promise<steptracespan[]> {
    return (await this.adapter.get<steptracespan[]>(`steptrace:${runid}`)) ?? [];
  }

  /** Stores one steptrace span of a run; the spans nest per step and per worker task through their parent refs. */
  async addsteptracespan(span: steptracespan): Promise<void> {
  ...
  async clearsteptrace(runid: string): Promise<void> {
  ...
  async getstartupsamples(): Promise<startupsample[]> {
    return (await this.adapter.get<startupsample[]>("startupsamples")) ?? [];
  }
  ...
  async addstartupsample(sample: startupsample): Promise<void> {
  ...
  async getslomosessions(): Promise<slowmosession[]> {
    return (await this.adapter.get<slowmosession[]>("slomosessions")) ?? [];
  }

  /** Stores one slowmo replay session; the pauses link to their steptrace spans for inspection. */
  async setslomosession(session: slowmosession): Promise<void> {
    await this.adapter.set("slomosessions", [
      session,
      ...(await this.getslomosessions()).filter((candidate) => candidate.runid !== session.runid),
    ]);
  }

  /** Returns the sessionreuse grants of the profile workspace with their consent prompts. */
  async getsessionreusegrants(): Promise<sessionreusegrant[]> {
    return (await this.adapter.get<sessionreusegrant[]>("sessionreusegrants")) ?? [];
  }

  /** Stores one sessionreuse grant; the authenticated profile attaches to a run only through its per profile consent prompt. */
  async addsessionreusegrant(grant: sessionreusegrant): Promise<void> {
    await this.adapter.set("sessionreusegrants", [
      ...(await this.getsessionreusegrants()).filter((candidate) => candidate.profile !== grant.profile),
      grant,
    ]);
  }

  /** Returns the artifactcompress records of the profile workspace for the at rest codec view. */
  async getartifactcompress(): Promise<artifactcompressrecord[]> {
    return (await this.adapter.get<artifactcompressrecord[]>("artifactcompress")) ?? [];
  }

  /** Stores one artifactcompress record: the codec of the stored artifact with its lazy read flag. */
  async addartifactcompress(record: artifactcompressrecord): Promise<void> {
    await this.adapter.set("artifactcompress", [
      ...(await this.getartifactcompress()).filter((candidate) => candidate.artifactid !== record.artifactid),
      record,
    ]);
  }
  ...
  async getrunrecord(runid: string): Promise<runrecord | undefined> {
    return ((await this.adapter.get<runrecord[]>("runs")) ?? []).find((record) => record.runid === runid);
  }

  /** Persists one run lifecycle record; the run state survives every service worker restart through the adapter. */
  async setrunrecord(record: runrecord): Promise<void> {
    await this.adapter.set("runs", [
      ...((await this.adapter.get<runrecord[]>("runs")) ?? []).filter((candidate) => candidate.runid !== record.runid),
      record,
    ]);
  }
  ...
  async listruns(): Promise<runrecord[]> {
    return [...((await this.adapter.get<runrecord[]>("runs")) ?? [])].sort((one, two) => two.updatedat - one.updatedat);
  }

  /** Returns the latest checkpoint of one run; a run without a checkpoint carries none. */
  async getcheckpoint(runid: string): Promise<checkpointrecord | undefined> {
    return ((await this.adapter.get<checkpointrecord[]>("checkpoints")) ?? []).find((record) => record.runid === runid);
  }

  /** Persists the latest checkpoint of one run; every newer checkpoint replaces the stored one. */
  async setcheckpoint(record: checkpointrecord): Promise<void> {
    await this.adapter.set("checkpoints", [
      ...((await this.adapter.get<checkpointrecord[]>("checkpoints")) ?? []).filter(
  ...
  async getqueue(): Promise<queuedtask[]> {
    return (await this.adapter.get<queuedtask[]>("offlinequeue")) ?? [];
  }

  /** Persists the offlinequeue; the replay drains it in sequence order once connectivity returns. */
  async setqueue(queue: queuedtask[]): Promise<void> {
    await this.adapter.set("offlinequeue", queue);
  }

  /** Returns the latest heartbeat record of one run. */
  async getheartbeat(runid: string): Promise<heartbeatrecord | undefined> {
    return ((await this.adapter.get<heartbeatrecord[]>("heartbeats")) ?? []).find((record) => record.runid === runid);
  }

  /** Persists the latest heartbeat record of one run; every beat replaces the stored one. */
  async setheartbeat(record: heartbeatrecord): Promise<void> {
    await this.adapter.set("heartbeats", [
      ...((await this.adapter.get<heartbeatrecord[]>("heartbeats")) ?? []).filter(
        (candidate) => candidate.runid !== record.runid,
      ),
      record,
    ]);
  ...
  async addrollback(item: rollbackitem): Promise<void> {
    await this.adapter.set("rollbackitems", [
      item,
      ...((await this.adapter.get<rollbackitem[]>("rollbackitems")) ?? []),
    ]);
  }

  /** Returns the rollback items of one run, newest first; a run without a rollback carries none. */
  async listrollbacks(runid: string): Promise<rollbackitem[]> {
    return ((await this.adapter.get<rollbackitem[]>("rollbackitems")) ?? []).filter((item) => item.runid === runid);
  }
  ...
  async getheartbeatwindow(): Promise<number | undefined> {
  ...
  async setheartbeatwindow(window: number): Promise<void> {
    const settings = (await this.getsettings()) ?? {};
  ...
  async getqueuedepthsetting(): Promise<number | undefined> {
  ...
  async setqueuedepthsetting(depth: number): Promise<void> {
    const settings = (await this.getsettings()) ?? {};
  ...
  async getexecutedkeys(runid: string): Promise<string[]> {
    return (
      ((await this.adapter.get<Array<{ runid: string; keys: string[] }>>("executedkeys")) ?? []).find(
  ...
  async addexecutedkey(runid: string, key: string): Promise<void> {
    const entries = ((await this.adapter.get<Array<{ runid: string; keys: string[] }>>("executedkeys")) ?? []).filter(
      (entry) => entry.runid !== runid,
    );
    await this.adapter.set("executedkeys", [
      ...entries,
      { runid, keys: [...(await this.getexecutedkeys(runid)), key] },
    ]);
  }
  ...
  async getvisits(runid: string): Promise<urlvisit[]> {
    return (await this.adapter.get<urlvisit[]>(`visits:${runid}`)) ?? [];
  }

  /** Persists the urlhistory of one run; the visits survive every service worker restart through the adapter. */
  async setvisits(runid: string, visits: urlvisit[]): Promise<void> {
  ...
  async getruntimeline(runid: string): Promise<runtimelineevent[]> {
    return (await this.adapter.get<runtimelineevent[]>(`runtimeline:${runid}`)) ?? [];
  }

  /** Persists the runtimeline stream of one run; the timeline view and the audit export read the same stream. */
  async setruntimeline(runid: string, events: runtimelineevent[]): Promise<void> {
  ...
  async appendtimelineevent(event: runtimelineevent): Promise<void> {
  ...
  async getlock(sessionid: string): Promise<lockrecord | undefined> {
    return ((await this.adapter.get<lockrecord[]>("sessionlocks")) ?? []).find(
  ...
  async setlock(lock: lockrecord): Promise<void> {
    await this.adapter.set("sessionlocks", [
      ...((await this.adapter.get<lockrecord[]>("sessionlocks")) ?? []).filter(
        (candidate) => candidate.sessionid !== lock.sessionid,
      ),
      lock,
    ]);
  }
  ...
  async clearlock(sessionid: string): Promise<void> {
    await this.adapter.set("sessionlocks", [
      ...((await this.adapter.get<lockrecord[]>("sessionlocks")) ?? []).filter(
  ...
  async listlocks(): Promise<lockrecord[]> {
    return (await this.adapter.get<lockrecord[]>("sessionlocks")) ?? [];
  }

  /** Returns the isolated tabstate of one tabid; a tab without an isolated namespace carries none. */
  async gettabstate(tabid: number): Promise<tabstate | undefined> {
    return ((await this.adapter.get<tabstate[]>("tabstates")) ?? []).find((state) => state.tabid === tabid);
  }
  ...
  async settabstate(state: tabstate): Promise<void> {
    await this.adapter.set("tabstates", [
      ...((await this.adapter.get<tabstate[]>("tabstates")) ?? []).filter(
        (candidate) => candidate.tabid !== state.tabid,
      ),
      state,
    ]);
  }
  ...
  async getmemoryitems(): Promise<memoryitem[]> {
    return (await this.adapter.get<memoryitem[]>("memoryitems")) ?? [];
  }
  ...
  async setmemoryitem(item: memoryitem): Promise<void> {
    await this.adapter.set("memoryitems", [
      ...(await this.getmemoryitems()).filter((candidate) => candidate.key !== item.key),
      item,
    ]);
  }

  /** Removes one memory item from the store; the purge keeps its summary and its provenance for the audit trail. */
  async removememoryitems(keys: string[]): Promise<void> {
    const gone = new Set(keys);
    await this.adapter.set(
      "memoryitems",
      (await this.getmemoryitems()).filter((item) => !gone.has(item.key)),
    );
  }

  /** Returns the user configured expiryrules of the memory workspace; an absent list keeps every item unexpired. */
  async getexpiry(): Promise<expiryrule[]> {
    return (await this.adapter.get<expiryrule[]>("expiryrules")) ?? [];
  }

  /** Persists the user configured expiryrules; every lifetime stays the user's choice with no forced ceiling. */
  async setexpiry(rules: expiryrule[]): Promise<void> {
  ...
  async getquotareport(): Promise<quotareport | undefined> {
    return await this.adapter.get<quotareport>("quotareport");
  }

  /** Persists the quotareport after each quotawatch pass; the cleanup candidates stay ranked for the next pass. */
  async setquotareport(report: quotareport): Promise<void> {
  ...
  async getencryptrest(): Promise<boolean> {
  ...
  async setencryptrest(enabled: boolean): Promise<void> {
    const settings = (await this.getsettings()) ?? {};
  ...
  async addpurgesummary(summary: {
    ...
    await this.adapter.set("purgesummaries", [
      summary,
      ...((await this.adapter.get<Array<{ key: string; summary: string; provenance: memoryprovenance; at: number }>>(
        "purgesummaries",
      )) ?? []),
    ]);
  }
  ...
  async listpurgesummaries(): Promise<
    Array<{ key: string; summary: string; provenance: memoryprovenance; at: number }>
  > {
    return (
      (await this.adapter.get<Array<{ key: string; summary: string; provenance: memoryprovenance; at: number }>>(
        "purgesummaries",
  ...
  async getlastexpirepass(): Promise<number | undefined> {
    return await this.adapter.get<number>("lastexpirepass");
  }

  /** Persists the timestamp of one expirememory pass. */
  async setlastexpirepass(at: number): Promise<void> {
  ...
  async getagent(agentid: string): Promise<agentrecord | undefined> {
    return ((await this.adapter.get<agentrecord[]>("fleet")) ?? []).find((record) => record.id === agentid);
  }

  /** Persists one fleet agentrecord; every newer record replaces the stored one and the registry survives every restart. */
  async setagent(record: agentrecord): Promise<void> {
    await this.adapter.set("fleet", [
      ...((await this.adapter.get<agentrecord[]>("fleet")) ?? []).filter((candidate) => candidate.id !== record.id),
      record,
    ]);
  }
  ...
  async listagents(): Promise<agentrecord[]> {
    return [...((await this.adapter.get<agentrecord[]>("fleet")) ?? [])].sort(
      (one, two) => two.registeredat - one.registeredat,
    );
  }

  /** Returns the budgetstate of one agent; an agent without a granted budget carries none. */
  async getbudget(agentid: string): Promise<budgetstate | undefined> {
    return ((await this.adapter.get<budgetstate[]>("agentbudgets")) ?? []).find((state) => state.agentid === agentid);
  }

  /** Returns the fleet scope of one agent; an agent without a configured scope stays unbounded inside the session grants. */
  async getagentscope(agentid: string): Promise<agentscope | undefined> {
    return ((await this.adapter.get<agentscope[]>("agentscopes")) ?? []).find((scope) => scope.agentid === agentid);
  }

  /** Persists the fleet scope of one agent; the intersection result with the session grants stays beside the registry. */
  async setagentscope(scope: agentscope): Promise<void> {
    await this.adapter.set("agentscopes", [
      ...((await this.adapter.get<agentscope[]>("agentscopes")) ?? []).filter(
        (candidate) => candidate.agentid !== scope.agentid,
      ),
      scope,
    ]);
  }
  ...
  async setbudget(state: budgetstate): Promise<void> {
    await this.adapter.set("agentbudgets", [
      ...((await this.adapter.get<budgetstate[]>("agentbudgets")) ?? []).filter(
        (candidate) => candidate.agentid !== state.agentid,
      ),
      state,
    ]);
  }
  ...
  async getreviews(): Promise<reviewrecord[]> {
    return [...((await this.adapter.get<reviewrecord[]>("fleetreviews")) ?? [])].sort(
      (one, two) =>
        (one.state === "open" ? 0 : 1) - (two.state === "open" ? 0 : 1) || two.requestedat - one.requestedat,
    );
  }

  /** Persists one fleet review record with the reviewer verdict recorded beside the original output. */
  async setreview(record: reviewrecord): Promise<void> {
    await this.adapter.set("fleetreviews", [
      ...((await this.adapter.get<reviewrecord[]>("fleetreviews")) ?? []).filter(
  ...
  async getreplays(agentid: string): Promise<replayrecord[]> {
    return [...((await this.adapter.get<replayrecord[]>(`fleetreplays:${agentid}`)) ?? [])].sort(
      (one, two) => two.capturedat - one.capturedat,
    );
  }
  ...
  async setreplay(record: replayrecord, retention?: number): Promise<void> {
    const kept = [record, ...(await this.getreplays(record.agentid)).filter((candidate) => candidate.id !== record.id)];
    await this.adapter.set(`fleetreplays:${record.agentid}`, retention === undefined ? kept : kept.slice(0, retention));
  }

  /** Returns every stored output comparison, newest first; the side by side view reads the same records. */
  async getcomparison(): Promise<comparisonrecord[]> {
    return [...((await this.adapter.get<comparisonrecord[]>("fleetcomparisons")) ?? [])].sort(
      (one, two) => two.comparedat - one.comparedat,
    );
  }

  /** Persists one output comparison record; the field by field alignment stays for the audit trail. */
  async setcomparison(record: comparisonrecord): Promise<void> {
    await this.adapter.set("fleetcomparisons", [
      ...((await this.adapter.get<comparisonrecord[]>("fleetcomparisons")) ?? []).filter(
        (candidate) => candidate.id !== record.id,
      ),
      record,
    ]);
  ...
  async getvotes(): Promise<consensusrecord[]> {
    const records = (await this.adapter.get<consensusrecord[]>("fleetvotes")) ?? [];
    return [...records].sort(
      (one, two) =>
        (one.outcome === "open" ? 0 : 1) - (two.outcome === "open" ? 0 : 1) ||
        Math.max(...two.votes.map((vote) => vote.castat), 0) - Math.max(...one.votes.map((vote) => vote.castat), 0),
    );
  }

  /** Persists one consensus record; the votes, the tally and the outcome stay for the audit trail with every dissenting vote. */
  async setvote(record: consensusrecord): Promise<void> {
    await this.adapter.set("fleetvotes", [
      ...((await this.adapter.get<consensusrecord[]>("fleetvotes")) ?? []).filter(
        (candidate) => candidate.id !== record.id,
      ),
      record,
    ]);
  ...
  async getkillswitchat(): Promise<number | undefined> {
    return await this.adapter.get<number>("killswitchat");
  }

  /** Persists the timestamp of one killswitch stop; one audit event per stopped agent lands beside it. */
  async setkillswitchat(at: number): Promise<void> {
  ...
  async getpausedagents(): Promise<string[]> {
    return ((await this.adapter.get<agentrecord[]>("fleet")) ?? [])
      .filter((record) => record.state === "paused")
  ...
  async getspawn(): Promise<spawnrecord[]> {
    return [...((await this.adapter.get<spawnrecord[]>("fleetspawns")) ?? [])].sort((one, two) => two.at - one.at);
  }
  ...
  async setspawn(record: spawnrecord): Promise<void> {
    await this.adapter.set("fleetspawns", [
      ...((await this.adapter.get<spawnrecord[]>("fleetspawns")) ?? []).filter(
        (candidate) => candidate.id !== record.id,
      ),
      record,
    ]);
  ...
  async getaggregate(): Promise<aggregaterecord[]> {
    return [...((await this.adapter.get<aggregaterecord[]>("fleetaggregates")) ?? [])].sort(
      (one, two) => (one.state === "open" ? 0 : 1) - (two.state === "open" ? 0 : 1) || two.createdat - one.createdat,
    );
  }
  ...
  async setaggregate(record: aggregaterecord, retention?: number): Promise<void> {
    const kept = [record, ...(await this.getaggregate()).filter((candidate) => candidate.id !== record.id)];
    await this.adapter.set("fleetaggregates", retention === undefined ? kept : kept.slice(0, retention));
  }

  /** Returns the stored interleaved fleet timeline ordered by event time; the merged lanes read the same events. */
  async getinterleaved(): Promise<interleaveevent[]> {
    return [...((await this.adapter.get<interleaveevent[]>("fleetinterleave")) ?? [])].sort(
      (one, two) => two.at - one.at,
    );
  }
  ...
  async setinterleaved(events: interleaveevent[], retention?: number): Promise<void> {
    await this.adapter.set("fleetinterleave", retention === undefined ? events : events.slice(0, retention));
  }
  ...
  async getlessons(): Promise<lessonrecord[]> {
    return [...((await this.adapter.get<lessonrecord[]>("fleetlessons")) ?? [])].sort(
      (one, two) => two.reusecount - one.reusecount || two.recordedat - one.recordedat,
    );
  }

  /** Persists one lessonrecord of the lessonshare; the sanitized finding stays for every agent that serves it. */
  async setlesson(lesson: lessonrecord): Promise<void> {
    await this.adapter.set("fleetlessons", [
      ...((await this.adapter.get<lessonrecord[]>("fleetlessons")) ?? []).filter(
  ...
  async getcases(): Promise<arbitrationcase[]> {
    return [...((await this.adapter.get<arbitrationcase[]>("fleetcases")) ?? [])].sort(
      (one, two) =>
        (one.state === "released" ? 1 : 0) - (two.state === "released" ? 1 : 0) || two.openedat - one.openedat,
    );
  }

  /** Persists one arbitrationcase with its verdict; the release keeps the closed case for the audit trail. */
  async setcase(record: arbitrationcase): Promise<void> {
    await this.adapter.set("fleetcases", [
      ...((await this.adapter.get<arbitrationcase[]>("fleetcases")) ?? []).filter(
        (candidate) => candidate.id !== record.id,
      ),
      record,
    ]);
  ...
  async getlanes(): Promise<tasklane[]> {
    return (await this.adapter.get<tasklane[]>("fleetlanes")) ?? [];
  }

  /** Persists the priority lanes of the task queue; the lane order and the interactive protection stay the user's choice. */
  async setlane(lanes: tasklane[]): Promise<void> {
  ...
  async getload(): Promise<loadreport[]> {
    return ((await this.adapter.get<loadreport[]>("fleetload")) ?? []).sort(
      (one, two) => two.sampledat - one.sampledat,
    );
  }

  /** Persists one loadreport sample per origin; every newer sample replaces the stored one of its origin. */
  async setload(report: loadreport): Promise<void> {
    await this.adapter.set(
      "fleetload",
      [
        report,
        ...((await this.adapter.get<loadreport[]>("fleetload")) ?? []).filter(
          (candidate) => candidate.origin !== report.origin,
        ),
      ].slice(0, 32),
    );
  }
  ...
  async getcosts(): Promise<costentry[]> {
    return [...((await this.adapter.get<costentry[]>("fleetcosts")) ?? [])].sort((one, two) => two.at - one.at);
  }

  /** Persists one costentry of the shared ledger attributed to its agent; the accounting stays local and read only. */
  async setcost(entry: costentry): Promise<void> {
    await this.adapter.set(
      "fleetcosts",
      [entry, ...((await this.adapter.get<costentry[]>("fleetcosts")) ?? [])].slice(0, 512),
    );
  }
  ...
  async getdepthlimit(): Promise<depthlimit | undefined> {
    return await this.adapter.get<depthlimit>("fleetdepthlimit");
  }

  /** Persists the user configured depthlimit of the sub agent recursion; the spawn gates read it exactly. */
  async setdepthlimit(limit: depthlimit): Promise<void> {
  ...
  async getclosedtabrecords(): Promise<closedtabrecord[]> {
    return [...((await this.adapter.get<closedtabrecord[]>("closedtabrecords")) ?? [])].sort(
      (one, two) => two.closedat - one.closedat,
    );
  }
  ...
  async addclosedtabrecord(record: closedtabrecord, retention?: number): Promise<void> {
    const stored = (await this.getclosedtabrecords()).filter((candidate) => candidate.id !== record.id);
    const kept =
      retention !== undefined && Number.isFinite(retention) && retention > 0
        ? stored.filter((candidate) => record.closedat - candidate.closedat <= retention)
        : stored;
  ...
  async setclosedtabrecord(record: closedtabrecord): Promise<void> {
    await this.adapter.set("closedtabrecords", [
      record,
      ...(await this.getclosedtabrecords()).filter((candidate) => candidate.id !== record.id),
    ]);
  }
  ...
  async getnavtrail(runid: string): Promise<navtrailentry[]> {
    return (await this.adapter.get<navtrailentry[]>(`navtrails:${runid}`)) ?? [];
  }
  ...
  async addnavtrailentry(runid: string, entry: navtrailentry): Promise<void> {
  ...
  async getnavratelimits(): Promise<ratelimitwindow[]> {
    return (await this.adapter.get<ratelimitwindow[]>("navratelimits")) ?? [];
  }

  /** Persists one navigation rate window per domain; every newer window replaces the stored one of its domain. */
  async setnavratelimitwindow(window: ratelimitwindow): Promise<void> {
    await this.adapter.set("navratelimits", [
      ...((await this.adapter.get<ratelimitwindow[]>("navratelimits")) ?? []).filter(
        (candidate) => candidate.domain !== window.domain,
      ),
      window,
    ]);
  }
  ...
  async getdeeplinks(): Promise<deeplinkpattern[]> {
    return (await this.adapter.get<deeplinkpattern[]>("deeplinkpatterns")) ?? [];
  }

  /** Persists one deeplinkpattern; a stored pattern of the same app and route gives way to the newer one. */
  async setdeeplink(pattern: deeplinkpattern): Promise<void> {
    await this.adapter.set("deeplinkpatterns", [
      ...((await this.adapter.get<deeplinkpattern[]>("deeplinkpatterns")) ?? []).filter(
        (candidate) => !(candidate.app === pattern.app && candidate.route === pattern.route),
      ),
      pattern,
    ]);
  }
  ...
  async getsafety(): Promise<safetyverdict[]> {
    return [...((await this.adapter.get<safetyverdict[]>("safetyverdicts")) ?? [])].sort((one, two) => two.at - one.at);
  }

  /** Persists one safetyverdict of the checksafeurl history; every refusal keeps its reasons for the audit trail. */
  async setsafetyverdict(verdict: safetyverdict): Promise<void> {
    await this.adapter.set(
      "safetyverdicts",
      [verdict, ...((await this.adapter.get<safetyverdict[]>("safetyverdicts")) ?? [])].slice(0, 256),
    );
  }
  ...
  async getprefetch(): Promise<prefetchplan | undefined> {
    return this.adapter.get<prefetchplan>("prefetchplans");
  }
  ...
  async setprefetch(plan: prefetchplan): Promise<void> {
  ...
  async getnavpause(): Promise<navpause | undefined> {
    return this.adapter.get<navpause>("navpauserecord");
  }
  ...
  async setnavpause(pause: navpause): Promise<void> {
  ...
  async getpipeline(runid?: string): Promise<extractpipeline[]> {
    const records = ((await this.adapter.get<extractpipeline[]>("extractpipelines")) ?? []).sort(
      (one, two) => two.updatedat - one.updatedat,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async setpipeline(pipeline: extractpipeline): Promise<void> {
    await this.adapter.set("extractpipelines", [
      pipeline,
      ...((await this.adapter.get<extractpipeline[]>("extractpipelines")) ?? []).filter(
  ...
  async getcursor(pipelineid: string): Promise<streamcursor | undefined> {
    return this.adapter.get<streamcursor>(`streamcursor:${pipelineid}`);
  }
  ...
  async setcursor(cursor: streamcursor): Promise<void> {
  ...
  async gettransforms(runid: string): Promise<transformrule[]> {
    return (await this.adapter.get<transformrule[]>(`pipelinetransforms:${runid}`)) ?? [];
  }
  ...
  async settransforms(runid: string, rules: transformrule[]): Promise<void> {
  ...
  async getrows(): Promise<extractbatch[]> {
    return [...((await this.adapter.get<extractbatch[]>("previewbatches")) ?? [])].sort((one, two) => two.at - one.at);
  }
  ...
  async setrows(batch: extractbatch, retention?: number): Promise<void> {
    const kept = [
      batch,
      ...((await this.adapter.get<extractbatch[]>("previewbatches")) ?? []).filter(
        (candidate) => candidate.id !== batch.id,
      ),
    ];
    await this.adapter.set(
      "previewbatches",
      retention !== undefined && Number.isFinite(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  }

  /** Returns the provlog entries of one run in append order; the provenance queries read the same append only log. */
  async getprovlog(runid: string): Promise<provlogentry[]> {
    return ((await this.adapter.get<provlogentry[]>(`provlog:${runid}`)) ?? []).sort(
      (one, two) => one.at - two.at || (one.id < two.id ? -1 : 1),
    );
  }
  ...
  async addprovlogentry(runid: string, entry: provlogentry): Promise<void> {
  ...
  async getsamplepolicy(planid: string): Promise<samplepolicy | undefined> {
    return this.adapter.get<samplepolicy>(`samplepolicy:${planid}`);
  }

  /** Persists the samplepolicy of one plan; the row count stays a user choice with no code ceiling. */
  async setsamplepolicy(planid: string, policy: samplepolicy): Promise<void> {
  ...
  async getdedupereports(runid?: string): Promise<dedupereport[]> {
    const records = [...((await this.adapter.get<dedupereport[]>("dedupereports")) ?? [])].sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async setdedupereport(report: dedupereport): Promise<void> {
    await this.adapter.set("dedupereports", [
      report,
      ...((await this.adapter.get<dedupereport[]>("dedupereports")) ?? []).filter(
  ...
  async getstreamfiles(runid?: string): Promise<streamfilerecord[]> {
    const records = [...((await this.adapter.get<streamfilerecord[]>("streamfiles")) ?? [])].sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addstreamfile(record: streamfilerecord): Promise<void> {
    await this.adapter.set("streamfiles", [
      record,
      ...((await this.adapter.get<streamfilerecord[]>("streamfiles")) ?? []).filter(
        (candidate) => candidate.id !== record.id,
      ),
    ]);
  }
  ...
  async getsourcestamps(runid: string): Promise<sourcestamprecord[]> {
    return ((await this.adapter.get<sourcestamprecord[]>(`sourcestamps:${runid}`)) ?? []).sort(
      (one, two) => two.capturedat - one.capturedat,
    );
  }
  ...
  async setsourcestamps(runid: string, stamps: sourcestamprecord[]): Promise<void> {
  ...
  async getsubscription(id: string): Promise<eventsubscription | undefined> {
  ...
  async getcache(runid?: string): Promise<cacheentry[]> {
    const records = ((await this.adapter.get<cacheentry[]>("webapicache")) ?? []).sort((one, two) => two.at - one.at);
    return runid !== undefined && runid.trim() !== "" ? records.filter((entry) => entry.runid === runid) : records;
  }
  ...
  async setcacheentry(entry: cacheentry, retention?: number): Promise<void> {
    const kept = [
      entry,
      ...((await this.adapter.get<cacheentry[]>("webapicache")) ?? []).filter(
  ...
  async expirycachepass(now: number): Promise<{ kept: cacheentry[]; expired: cacheentry[] }> {
    const records = (await this.adapter.get<cacheentry[]>("webapicache")) ?? [];
    const kept = records.filter((entry) => entry.expiry === undefined || now < entry.expiry);
    const expired = records.filter((entry) => entry.expiry !== undefined && now >= entry.expiry);
  ...
  async getcorrelation(runid: string): Promise<correlationcontext | undefined> {
    return this.adapter.get<correlationcontext>(`webapicorrelation:${runid}`);
  }
  ...
  async setcorrelation(context: correlationcontext): Promise<void> {
  ...
  async getratelimitdirectives(now: number): Promise<ratelimitdirective[]> {
    const records = (await this.adapter.get<ratelimitdirective[]>("webapiratelimits")) ?? [];
  ...
  async setratelimitdirective(directive: ratelimitdirective): Promise<void> {
    const records = ((await this.adapter.get<ratelimitdirective[]>("webapiratelimits")) ?? []).filter(
      (candidate) => !(candidate.origin === directive.origin && candidate.scope === directive.scope),
    );
  ...
  async getapicalls(runid?: string): Promise<apicallrecord[]> {
    const records = ((await this.adapter.get<apicallrecord[]>("webapicalls")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addapicall(record: apicallrecord, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<apicallrecord[]>("webapicalls")) ?? [])];
    await this.adapter.set(
      "webapicalls",
      retention !== undefined && Number.isFinite(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  ...
  async getpollchoices(): Promise<{ timeout?: number; backoff?: number }> {
    return (await this.adapter.get<{ timeout?: number; backoff?: number }>("webapipollchoices")) ?? {};
  }
  ...
  async setpollchoices(choices: { timeout?: number; backoff?: number }): Promise<void> {
  ...
  async getocrs(runid?: string): Promise<ocrresult[]> {
    const records = ((await this.adapter.get<ocrresult[]>("visionocr")) ?? []).sort((one, two) => two.at - one.at);
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addocr(record: ocrresult, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<ocrresult[]>("visionocr")) ?? [])];
    await this.adapter.set(
      "visionocr",
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  }
  ...
  async getvisions(runid?: string): Promise<visiondescription[]> {
    const records = ((await this.adapter.get<visiondescription[]>("visiondescriptions")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addvision(record: visiondescription, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<visiondescription[]>("visiondescriptions")) ?? [])];
    await this.adapter.set(
      "visiondescriptions",
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  ...
  async getmasks(runid?: string): Promise<redactionmask[]> {
    const records = ((await this.adapter.get<redactionmask[]>("visionmasks")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addmask(record: redactionmask, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<redactionmask[]>("visionmasks")) ?? [])];
    await this.adapter.set(
      "visionmasks",
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  ...
  async getscreenshotpairs(runid?: string): Promise<screenshotpair[]> {
    const records = ((await this.adapter.get<screenshotpair[]>("visionscreenshotpairs")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addscreenshotpair(record: screenshotpair, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<screenshotpair[]>("visionscreenshotpairs")) ?? [])];
    await this.adapter.set(
      "visionscreenshotpairs",
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  }

  /** Returns the stored grounding results of the 1.1.77 family, newest first; a run id narrows the read to its own groundings. */
  async getgroundings(runid?: string): Promise<groundingresult[]> {
    const records = ((await this.adapter.get<groundingresult[]>("visiongroundings")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addgrounding(record: groundingresult, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<groundingresult[]>("visiongroundings")) ?? [])];
    await this.adapter.set(
      "visiongroundings",
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  ...
  async getframereads(runid?: string): Promise<framereference[]> {
    const records = ((await this.adapter.get<framereference[]>("visionframereads")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addframeread(record: framereference, retention?: number): Promise<void> {
    const previous = (await this.adapter.get<framereference[]>("visionframereads")) ?? [];
    const fresh =
      retention !== undefined && Number.isFinite(retention) && retention > 0
        ? previous.filter((candidate) => record.at - candidate.at < retention)
        : previous;
    await this.adapter.set("visionframereads", [
      record,
      ...fresh.filter(
        (candidate) =>
          !(
            candidate.runid === record.runid &&
            candidate.selector === record.selector &&
            candidate.positionms === record.positionms
          ),
      ),
    ]);
  }
  ...
  async getvisionconfig(): Promise<{ model?: string; endpoint?: string }> {
    return (await this.adapter.get<{ model?: string; endpoint?: string }>("visionconfig")) ?? {};
  }
  ...
  async setvisionconfig(config: { model?: string; endpoint?: string }): Promise<void> {
  ...
  async getvisioncache(runid?: string): Promise<visioncacheentry[]> {
    const records = ((await this.adapter.get<visioncacheentry[]>("visioncache")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((entry) => entry.runid === runid) : records;
  }
  ...
  async setvisioncacheentry(entry: visioncacheentry): Promise<void> {
    const kept = [
      entry,
      ...((await this.adapter.get<visioncacheentry[]>("visioncache")) ?? []).filter(
  ...
  async expirevisioncachepass(
    now: number,
    retention?: number,
  ): Promise<{ kept: visioncacheentry[]; expired: visioncacheentry[] }> {
    const records = (await this.adapter.get<visioncacheentry[]>("visioncache")) ?? [];
    const kept = records.filter((entry) => retention === undefined || now - entry.at < retention);
    const expired = records.filter((entry) => retention !== undefined && now - entry.at >= retention);
  ...
  async getvisioncalls(runid?: string): Promise<Array<{ runid: string; kind: string; model: boolean; at: number }>> {
    const records = (
      (await this.adapter.get<Array<{ runid: string; kind: string; model: boolean; at: number }>>("visioncalls")) ?? []
  ...
  async addvisioncall(record: { runid: string; kind: string; model: boolean; at: number }): Promise<void> {
    await this.adapter.set("visioncalls", [
      record,
      ...((await this.adapter.get<Array<{ runid: string; kind: string; model: boolean; at: number }>>("visioncalls")) ??
        []),
    ]);
  ...
  async getbeforeafters(runid?: string): Promise<beforeafterpair[]> {
    const records = ((await this.adapter.get<beforeafterpair[]>("forensicpairs")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addbeforeafter(record: beforeafterpair, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<beforeafterpair[]>("forensicpairs")) ?? [])];
    await this.adapter.set(
      "forensicpairs",
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  ...
  async setbeforeafters(records: beforeafterpair[]): Promise<void> {
  ...
  async getconsoletimeline(runid: string): Promise<consoletraceentry[]> {
    return ((await this.adapter.get<consoletraceentry[]>(`forensicconsole:${runid}`)) ?? []).sort(
      (one, two) => one.sequence - two.sequence,
    );
  }
  ...
  async addconsoleentry(runid: string, entry: consoletraceentry, retention?: number): Promise<void> {
    const kept = [...((await this.adapter.get<consoletraceentry[]>(`forensicconsole:${runid}`)) ?? []), entry];
    await this.adapter.set(
      `forensicconsole:${runid}`,
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(-retention) : kept,
    );
  }
  ...
  async getnettraces(runid: string): Promise<nettraceentry[]> {
    return ((await this.adapter.get<nettraceentry[]>(`forensicnet:${runid}`)) ?? []).sort(
      (one, two) => one.at - two.at,
    );
  }
  ...
  async addnettrace(runid: string, entry: nettraceentry, retention?: number): Promise<void> {
    const kept = [...((await this.adapter.get<nettraceentry[]>(`forensicnet:${runid}`)) ?? []), entry];
    await this.adapter.set(
      `forensicnet:${runid}`,
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(-retention) : kept,
    );
  ...
  async getdiffbases(runid?: string): Promise<diffbaserecord[]> {
    const records = ((await this.adapter.get<diffbaserecord[]>("forensicdiffbases")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async setdiffbase(record: diffbaserecord): Promise<void> {
    const kept = [
      record,
      ...((await this.adapter.get<diffbaserecord[]>("forensicdiffbases")) ?? []).filter(
        (candidate) => !(candidate.runid === record.runid && candidate.pagestate === record.pagestate),
      ),
    ];
  ...
  async getdiffresults(runid?: string): Promise<diffresult[]> {
    const records = ((await this.adapter.get<diffresult[]>("forensicdiffresults")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async adddiffresult(record: diffresult, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<diffresult[]>("forensicdiffresults")) ?? [])];
    await this.adapter.set(
      "forensicdiffresults",
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  ...
  async setdiffresults(records: diffresult[]): Promise<void> {
  ...
  async getthumbs(runid?: string): Promise<thumbnailrecord[]> {
    const records = ((await this.adapter.get<thumbnailrecord[]>("forensicthumbs")) ?? []).sort(
      (one, two) => two.at - one.at,
    );
    return runid !== undefined && runid.trim() !== "" ? records.filter((record) => record.runid === runid) : records;
  }
  ...
  async addthumb(record: thumbnailrecord, retention?: number): Promise<void> {
    const kept = [record, ...((await this.adapter.get<thumbnailrecord[]>("forensicthumbs")) ?? [])];
    await this.adapter.set(
      "forensicthumbs",
      retention !== undefined && Number.isInteger(retention) && retention > 0 ? kept.slice(0, retention) : kept,
    );
  ...
  async setthumbs(records: thumbnailrecord[]): Promise<void> {
  ...
  async getlapse(runid: string): Promise<timelapseframe[]> {
    return ((await this.adapter.get<timelapseframe[]>(`forensiclapse:${runid}`)) ?? []).sort(
      (one, two) => one.sequence - two.sequence,
    );
  }
  ...
  async addlapseframe(runid: string, frame: timelapseframe): Promise<void> {
    const kept = [
      ...((await this.adapter.get<timelapseframe[]>(`forensiclapse:${runid}`)) ?? []).filter(
  ...
  async getlapseconfig(runid: string): Promise<timelapseconfig | undefined> {
    return this.adapter.get<timelapseconfig>(`forensiclapseconfig:${runid}`);
  }
  ...
  async setlapseconfig(config: timelapseconfig): Promise<void> {
  ...
  async getnames(): Promise<capturenamerule | undefined> {
    return this.adapter.get<capturenamerule>("forensicnames");
  }
  ...
  async setnamerule(rule: capturenamerule): Promise<void> {
  ...
  async getforensicchoices(): Promise<{
    ...
    if (settings?.diffthreshold !== undefined) choices.diffthreshold = settings.diffthreshold;
    if (settings?.timelapseinterval !== undefined) choices.timelapseinterval = settings.timelapseinterval;
    if (settings?.thumbnailedge !== undefined) choices.thumbnailedge = settings.thumbnailedge;
    if (settings?.forensicretention !== undefined) choices.forensicretention = settings.forensicretention;
    return choices;
  }
  ...
  async setforensicchoices(choices: {
    ...
    await this.setsettings({
      ...settings,
      ...(choices.diffthreshold !== undefined ? { diffthreshold: choices.diffthreshold } : {}),
      ...(choices.timelapseinterval !== undefined ? { timelapseinterval: choices.timelapseinterval } : {}),
      ...(choices.thumbnailedge !== undefined ? { thumbnailedge: choices.thumbnailedge } : {}),
  ...
  async getminpolicies(): Promise<{ purge?: purgepolicy; cleanup?: cleanupschedule; sync?: syncsettings }> {
    return (
      (await this.adapter.get<{ purge?: purgepolicy; cleanup?: cleanupschedule; sync?: syncsettings }>(
        "minpolicies",
      )) ?? ({} as { purge?: purgepolicy; cleanup?: cleanupschedule; sync?: syncsettings })
    );
  }
  ...
  async getsyncrecords(): Promise<syncrecord[]> {
    return (await this.adapter.get<syncrecord[]>("syncrecords")) ?? [];
  }
  ...
  async addsyncrecord(record: syncrecord): Promise<void> {
    await this.adapter.set("syncrecords", [
      record,
      ...(await this.getsyncrecords()).filter((candidate) => candidate.id !== record.id),
    ]);
  }
  ...
  async getjars(): Promise<cookiejarrecord[]> {
    return (await this.adapter.get<cookiejarrecord[]>("cookiejars")) ?? [];
  }
  ...
  async setjar(jar: cookiejarrecord): Promise<void> {
    await this.adapter.set("cookiejars", [
      ...(await this.getjars()).filter((candidate) => candidate.jarid !== jar.jarid),
      jar,
    ]);
  }
  ...
  async getlocalrules(): Promise<localrule[]> {
    return (await this.adapter.get<localrule[]>("localrules")) ?? [];
  }
  ...
  async setlocalrule(rule: localrule): Promise<void> {
    await this.adapter.set("localrules", [
      ...(await this.getlocalrules()).filter((candidate) => candidate.origin !== rule.origin),
      rule,
    ]);
  }
  ...
  async gettelemetrypolicy(): Promise<telemetrypolicy> {
    return (
      (await this.adapter.get<telemetrypolicy>("telemetrypolicy")) ?? {
        enabled: false,
        counters: "local",
        at: Date.now(),
      }
  ...
  async settelemetrypolicy(policy: telemetrypolicy): Promise<void> {
  ...
  async getexportbundles(): Promise<exportallbundle[]> {
    return (await this.adapter.get<exportallbundle[]>("exportallbundles")) ?? [];
  }
  ...
  async addexportbundle(bundle: exportallbundle): Promise<void> {
    await this.adapter.set("exportallbundles", [
      bundle,
      ...(await this.getexportbundles()).filter((candidate) => candidate.id !== bundle.id),
    ]);
  }
  ...
  async setbundledownload(bundleid: string, downloadid: string): Promise<void> {
    await this.adapter.set("exportalldownloads", {
      ...((await this.adapter.get<Record<string, string>>("exportalldownloads")) ?? {}),
      [bundleid]: downloadid,
    });
  }

  /** Lists the download links of the exportall bundles of the 1.1.79 family by bundle id. */
  async getbundledownloads(): Promise<Record<string, string>> {
    return (await this.adapter.get<Record<string, string>>("exportalldownloads")) ?? {};
  }
  ...
  async flagretainedartifacts(ids: string[]): Promise<void> {
    const kept = new Set([...((await this.adapter.get<string[]>("retainedartifacts")) ?? []), ...ids]);
  ...
  async getretainedartifacts(): Promise<string[]> {
    return (await this.adapter.get<string[]>("retainedartifacts")) ?? [];
  }
  ...
  async purgekeys(keys: string[]): Promise<void> {
  ...
  async getexport(now: number): Promise<auditexportrecord> {
    ...
    return {
      at: now,
      runs,
      memory: await this.getmemoryitems(),
      expiryrules: await this.getexpiry(),
      timeline,
      locks: await this.listlocks(),
    };
  }
  ...
  async getbridgesessions(): Promise<bridgesessionrecord[]> {
    return (await this.adapter.get<bridgesessionrecord[]>("bridgesessions")) ?? [];
  }
  ...
  async setbridgesessions(records: bridgesessionrecord[]): Promise<void> {
  ...
  async addbridgesession(record: bridgesessionrecord): Promise<void> {
    await this.adapter.set("bridgesessions", [
      record,
      ...(await this.getbridgesessions()).filter((candidate) => candidate.id !== record.id),
    ]);
  }
  ...
  async getbridgepairings(): Promise<bridgepairingrecord[]> {
    return (await this.adapter.get<bridgepairingrecord[]>("bridgepairings")) ?? [];
  }

  /** Stores the bridge pairing records of the 1.1.82 site bridge in one pass. */
  async setbridgepairings(records: bridgepairingrecord[]): Promise<void> {
  ...
  async addbridgepairing(record: bridgepairingrecord): Promise<void> {
    await this.adapter.set("bridgepairings", [
      record,
      ...(await this.getbridgepairings()).filter((candidate) => candidate.origin !== record.origin),
    ]);
  }

  /** Lists the relay token records of the 1.1.82 site bridge: the sha-256 hashes scoped to the relay origin, never a raw token. */
  async getbridgetokens(): Promise<relaytokenrecord[]> {
    return (await this.adapter.get<relaytokenrecord[]>("bridgetokens")) ?? [];
  }
  ...
  async setbridgetokens(records: relaytokenrecord[]): Promise<void> {
  ...
  async getbridgeevents(): Promise<bridgeeventrecord[]> {
    return (await this.adapter.get<bridgeeventrecord[]>("bridgeevents")) ?? [];
  }
  ...
  async addbridgeevent(event: bridgeeventrecord): Promise<void> {
    await this.adapter.set("bridgeevents", [
      event,
      ...(await this.getbridgeevents()).filter((candidate) => candidate.opid !== event.opid),
    ]);
  }
  ...
  async getbridgequeue(): Promise<bridgequeuerecord[]> {
    return (await this.adapter.get<bridgequeuerecord[]>("bridgequeue")) ?? [];
  }

  /** Stores the offline bridge queue of the 1.1.82 site bridge in one pass so the replay and the buffer never race. */
  async setbridgequeue(records: bridgequeuerecord[]): Promise<void> {
  ...
  async getbridgeswitch(): Promise<bridgekillswitch | undefined> {
    return this.adapter.get<bridgekillswitch>("bridgeswitch");
  }

  /** Stores the bridge kill switch stamp of the 1.1.82 site bridge; one click disables the socket and the pairing instantly. */
  async setbridgeswitch(stamp: bridgekillswitch): Promise<void> {
  ...
  async getnativestate(): Promise<nativehoststate | undefined> {
    return this.adapter.get<nativehoststate>("nativestate");
  }
  ...
  async setnativestate(state: nativehoststate): Promise<void> {
  ...
  async getnativecalls(): Promise<nativecallrecord[]> {
    return (await this.adapter.get<nativecallrecord[]>("nativecalls")) ?? [];
  }

  /** Replaces the stored native call set after one recorded call so the audit trail survives the service worker restarts. */
  async setnativecalls(records: nativecallrecord[]): Promise<void> {
  ...
  async addnativecall(record: nativecallrecord): Promise<void> {
    await this.adapter.set("nativecalls", [
      record,
      ...(await this.getnativecalls()).filter((candidate) => candidate.id !== record.id),
    ]);
  }

  /** Reads the kill switch stamp of the 1.1.85 native transport; an absent stamp leaves the switch released. */
  async getnativeswitch(): Promise<nativekillswitch | undefined> {
    return this.adapter.get<nativekillswitch>("nativeswitch");
  }
  ...
  async setnativeswitch(stamp: nativekillswitch): Promise<void> {
  ...
  async getnativebridgesessions(): Promise<wsbridgesession[]> {
    return (await this.adapter.get<wsbridgesession[]>("nativebridgesessions")) ?? [];
  }
  ...
  async setnativebridgesessions(sessions: wsbridgesession[]): Promise<void> {
...
export const sensitivememoryclasses: ReadonlySet<string> = new Set([
  "credential",
  "secret",
  "token",
  "body",
...
export function memoryitemof(input: {
  key: string;
  value: unknown;
  provenance: memoryprovenance;
  memoryclass?: string;
  ...
  return {
    ...
    ...(input.memoryclass !== undefined && input.memoryclass.trim() !== "" ? { memoryclass: input.memoryclass } : {}),
...
export function stepsummaryfor(item: memoryitem, steps: toolstep[]): string {
  ...
  if (step === undefined)
    return `The provenance names the step ${item.provenance.stepid} of the run ${item.provenance.runid} which the current plan no longer carries; the item keeps its provenance for the audit trail.`;
  return step.summary !== ""
    ? step.summary
    : `The ${step.kind} step ${step.id} of the run ${item.provenance.runid} captured this item on ${item.provenance.origin}.`;
}
...
export function purgeitems(input: { items: memoryitem[]; rules: expiryrule[]; confirmed: boolean; now: number }): {
  kept: memoryitem[];
  purged: purgeoutcome[];
} {
  ...
  const purged = input.items
    .filter((item) => expired.has(item.key))
    .map((item) => ({
      key: item.key,
      summary: `The memory item ${item.key} of the ${item.memoryclass ?? "general"} class expired under its user expiryrule and purged; its value left while its provenance stays for the audit trail.`,
...
export function quotareportof(input: {
  usage: number;
  quota: number;
  items: memoryitem[];
  rules: expiryrule[];
...
export function rankedcandidates(
  ...
  rules: expiryrule[],
  now: number,
): Array<{ key: string; bytes: number; reason: string }> {
  ...
  return measured
    ...
    .map((entry) => ({
      key: entry.item.key,
      bytes: entry.bytes,
      reason: expiredset.has(entry.item.key)
        ? "The item expired under its user expiryrule; its purge reclaims its bytes while its summary stays for the audit trail."
        : `The ${entry.item.memoryclass ?? "general"} item of the run ${entry.item.provenance.runid} aged past its capture; the cleanup proposes it as a reclaimable candidate and the audit history never enters the batch.`,
    }));
}
...
export function cleanupbatch(
  ...
  const sized =
    batchsize !== undefined && Number.isInteger(batchsize) && batchsize > 0
...
export function auditexportof(input: {
  runs: runrecord[];
  items: memoryitem[];
  rules: expiryrule[];
...
export function exportchunks(
  ...
  chunksize: number,
): Array<{ index: number; payload: string; done: boolean }> {
  if (!Number.isInteger(chunksize) || chunksize <= 0)
    throw new Error(
      "The export chunk size must stay a positive whole number of characters; the size stays the caller's choice with no code cap.",
    );
...
export async function derivekey(secret: string, salt: string): Promise<CryptoKey> {
  if (secret.length === 0)
    throw new Error("The encryption needs its user secret; the secret entry stays a consent prompt.");
...
export async function decryptvalue(key: CryptoKey, envelope: encryptedenvelope): Promise<unknown> {
  ...
  const plain = await crypto.subtle.decrypt(
    { name: "AES-GCM", iv },
    key,
    Uint8Array.from(atob(envelope.payload), (char) => char.charCodeAt(0)),
  );
...
export function cacheselentry(cache: selcachestate, entry: { selector: string; resolution: string }): selcachestate {
  ...
  return {
    ...cache,
    entries: [...entries, { selector: entry.selector, resolution: entry.resolution, generation: cache.generation }],
  };
}
...
export function advanceselcachegeneration(cache: selcachestate, now: number): selcachestate {
  return {
    ...
    invalidations: [...cache.invalidations, { reason: "generation", at: now, selectors: [] }],
  };
}
...
export function selcachelookup(
  cache: selcachestate,
  selector: string,
): { hit: boolean; resolution?: string; stale: boolean; reason: string } {
  const entry = cache.entries.find((candidate) => candidate.selector === selector);
  if (entry === undefined)
    return {
      hit: false,
      stale: false,
      reason: "The selcache holds no entry for the selector; the resolver runs its fresh query.",
    };
  if (entry.generation !== cache.generation)
    return {
      hit: false,
      stale: true,
      reason: `The selcache entry for ${selector} resolves from generation ${entry.generation} while the run stands at generation ${cache.generation}; revalidate the entry or query the selector fresh.`,
    };
  return {
    hit: true,
    ...
    stale: false,
    reason:
      "The selcache entry resolves from the current generation; the revalidation query confirms it before the dispatch.",
  };
}
...
export function invalidateselcacheonnavigation(cache: selcachestate, now: number): selcachestate {
  ...
  return {
    ...cache,
    entries: [],
    invalidations: [...cache.invalidations, { reason: "navigation", at: now, selectors }],
  };
}
...
export function invalidateselcacheonmutations(
  cache: selcachestate,
  fingerprints: string[],
  now: number,
): selcachestate {
  const matching = cache.entries
    .filter((entry) =>
      fingerprints.some((fingerprint) => entry.selector.includes(fingerprint) || fingerprint.includes(entry.selector)),
    )
    .map((entry) => entry.selector);
  return {
    ...cache,
    entries: cache.entries.filter((entry) => !matching.includes(entry.selector)),
    invalidations: [...cache.invalidations, { reason: "mutation", at: now, selectors: matching }],
  };
}
...
export function revalidateselentry(
  cache: selcachestate,
  input: { selector: string; freshresolution: string },
): selcachestate {
  ...
  return {
    ...cache,
    entries: cache.entries.map((candidate) =>
      candidate.selector === input.selector
        ? { ...candidate, resolution: input.freshresolution, generation: cache.generation }
        : candidate,
    ),
  };
}
...
export function selcachestats(
  cache: selcachestate,
  lookups: Array<{ hit: boolean; stale: boolean }>,
): { hits: number; stale: number; total: number } {
  return {
    hits: lookups.filter((lookup) => lookup.hit).length,
    stale: lookups.filter((lookup) => lookup.stale).length,
...
export function stalegenerationfailure(input: {
  stepid: string;
  runid: string;
  selector: string;
  ...
  now: number;
}): { message: string; retry: { allowed: boolean; reason: string }; context: Record<string, string> } {
  return {
    ...
    retry: {
      allowed: true,
      reason: `Revalidate the ${input.selector} entry under generation ${input.currentgeneration} or query the selector fresh through a new reviewed dispatch; the retry rides the full consent gate chain.`,
    },
    context: {
      selector: input.selector,
      entrygeneration: String(input.entrygeneration),
      currentgeneration: String(input.currentgeneration),
    },
  };
}
...
export function markv1sunset(
  existing: v1sunsetstate | undefined,
  input: { declared: number; clientid: string; now: number },
): v1sunsetstate {
...
export function migrationpromptof(
  existing: migrationpromptstate | undefined,
  input: { previous: string | undefined; now: number },
): { prompt: boolean; state?: migrationpromptstate } {
...
export function dismissmigrationprompt(
  existing: migrationpromptstate | undefined,
  now: number,
): migrationpromptstate | undefined {
  if (existing === undefined) return undefined;
