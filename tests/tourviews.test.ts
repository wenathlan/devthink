...
import { a11ylabelof, a11ylabelsfor, a11ylabelslocalizedfor, featuretourordered, featuretourstopat, featuretourstops } from "../views.js";
...
describe("featuretour and a11ylabels", () => {
  it("replays the onboarding walkthrough with added stops for the datagrid, the compareviewer and the pickeroverlay", () => {
    ...
    expect(stops.map(stop => stop.id)).toEqual(["origingrants", "planreview", "runcontrol", "logaudit", "datagrid", "compareviewer", "pickeroverlay", "chunkextract"]);
