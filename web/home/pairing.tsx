...
export function PairingPanel({ gatewayUrl, pairingId, code, userId, expiresAt, paired, preferences, onPreferenceChange, onGatewayChange, onPairingIdChange, onCodeChange, onSubmit, onRevoke }: PairingPanelProps) {
