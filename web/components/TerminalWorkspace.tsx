/** Design: DevThink v1.1.11 — browser workspace preserves real sessions and control destinations in one aligned local-first shell. */
...
import type { DevThinkMessage, DevThinkProvider, DevThinkTab } from "./devthink-types";
...
export function TerminalWorkspace({ sectionId, routeLabel, provider, messages, tabs, activeTabId, draft, paired, onDraftChange, onSend, onCategory, onDestination, onSelectTab, onCloseTab, onNewTab, onOpenPalette }: TerminalWorkspaceProps) {
  ...
  return (
    <main className="terminal-workspace terminal-workspace--v111">
      <aside className="workspace-rail" aria-label="DevThink workspace destinations">
      ...
      <div className="terminal-workspace__main">
        <header className="browser-chrome">
          <div className="browser-chrome__identity"><span aria-hidden="true">✦</span><strong>DEVTHINK</strong><small>{paired ? "paired" : "local"}</small></div>
